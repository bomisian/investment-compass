...
const EVENT_DATA = {
  "schemaVersion": 1,
  "generatedAt": 1789071975.0536184,
  "events": [
    {
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "| Motley Fool 접근성 도움말 회사 소개 ▲ S&P 500 + ---% | ▲ Stock Advisor + ---% Motley Fool Sandisk에 참여하세요( SNDK -3.13% ) 주가는 오전 10시 5분까지 3.8% 하락했습니다.",
      ...
      "marketInterpretation": [
        ...
        "이번 기사에서 확인된 구체적 수치: $2,100, $1,700, 3.13 % — 공식 실적·가이던스와 일치하는지 확인이 필요합니다.",
    ...
    },
    {
      ...
      "source": {
        ...
        "collectedAt": 1789054861.9518685
      },
      "confirmedFacts": [],
      "reportedClaims": [
    ...
    },
    {
      ...
      "reportedClaims": [
        ...
        "내용으로 건너뛰기 ❚❚ 종가 S&P 500 7,612.60 −0.41% Dow Jones 52,160.00 −0.53% Nasdaq 100 29,207.60 −0.77% Russell 2000 2,901.95 −0.73% S&P 500 7,612.60 −0.41% 다우존스 52,160.00 −0.53% 나스닥 100 29,207.60 −0.77% 러셀 2000 2,901.95 −0.",
    ...
    },
    {
      ...
      "marketInterpretation": [
        "AI CAPEX 변화는 반도체·클라우드 수요와 투자 기업의 현금흐름을 서로 다른 방향으로 바꿀 수 있습니다.",
        "이번 기사에서 확인된 구체적 수치: 1.36 %, $ 429.43, $2.3 — 공식 실적·가이던스와 일치하는지 확인이 필요합니다.",
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "Broadcom은 2028년 AI 반도체 수익이 2,300억 달러에 달할 것으로 예측합니다. 결과적으로 주가는 주당 900달러에 도달할 수 있습니다."
      ],
      "marketInterpretation": [],
      "aiInference": [
        "사업·실적 연결 경로는 다음 공시에서 확인합니다."
    ...
    },
    {
      ...
      "reportedClaims": [
        "메모리 공급 부족과 가격 급등이 iPhone 18 제조원가를 높일 수 있다는 내용입니다.",
        "기사 본문에서 언급된 수치: $101,, 0.20%, 0.12%, 0.14%, 5.61%, 0.63%, 0.32%, 2.01%.",
        "애플의 공식 판매가·출하량 확정치가 아니라 외부 전망과 업계 추정이 섞인 뉴스입니다."
      ],
      "marketInterpretation": [
        "메모리 가격 상승이 반도체 업체 실적을 넘어 완제품 가격으로 전가되는지 확인하는 신호입니다.",
    ...
    },
    {
      ...
      "marketInterpretation": [
        "장기 계약은 매출 가시성을 높일 수 있지만 최소구매 의무·취소 조건·실제 인식 시점이 확인돼야 합니다.",
        "이번 기사에서 확인된 구체적 수치: 59.18%, 24.99%, 0.66% — 공식 실적·가이던스와 일치하는지 확인이 필요합니다.",
    ...
    },
    {
      ...
      "source": {
        ...
        "publishedAt": 1788966000.0,
        "collectedAt": 1789070104.6532128
      },
      "confirmedFacts": [
    ...
    },
    {
      ...
      "reportedClaims": [
        ...
        "| Motley Fool 접근성 도움말 회사 소개 ▲ S&P 500 + ---% | ▲ Stock Advisor + ---% Join The Motley Fool 인프라 수요가 전 세계적으로 급증함에 따라 Eaton(ETN -0.38%)과 Vertiv(VRT -4.20%) 중에서 선택하려면 저울질 설정이 필요합니다.",
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "3분기 실적 미리보기: NVDA, AMD가 AI 기반 시장 랠리 주도 메인 콘텐츠로 건너뛰기 → Elon Musk의 Hushed FCC Filing.",
        "(Paradigm Press에서) (광고) 3분기 실적은 시장이 기다려온 촉매제가 될 수 있음 Written by Thomas Hughes | Clare Titus가 검토함 2026년 9월 8일 기본 소스로 추가 공유 공유 이 기사 공유 링크가 클립보드에 복사됨",
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "UBS, Eaton Corp를 매수로 업그레이드하고 목표 가격을 515달러로 높임"
      ],
      "marketInterpretation": [],
      "aiInference": [
        "사업·실적 연결 경로는 다음 공시에서 확인합니다."
