...
const EVENT_DATA = {
  "schemaVersion": 1,
  "generatedAt": 1789891951.9215834,
  "events": [
    {
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "SanDisk Stock Jumped 11% on S&amp;P 100 News.",
        "| TIKR.com General Investing SanDisk Stock Jumped 11% on S&P 100 News.",
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "엔비디아: 2026년에는 어떤 기술 재고가 더 나은 구매입니까?",
        "| The Motley Fool 접근성 도움말 회사 소개 ▲ S&P 500 + --- % | ▲ Stock Advisor + --- % Motley Fool에 가입 디지털 세계가 확장됨에 따라 투자자들은 스마트폰의 모든 기능을 제공하는 칩을 통해 수익을 올릴 수 있는 최선의 방법을 찾고 있습니다.",
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "인텔은 고객이 원하는 것의 절반만 공급할 수 있습니다.",
        "생각보다 좋은 문제네요.",
        "| The Motley Fool Accessibility Help About Us ▲ S&P 500 + --- % | ▲ Stock Advisor + --- % Join The Motley Fool Intel (INTC -0.18%) CEO Lip-Bu Tan은 이번 주 덴버에서 열린 Splunk의 .conf26 컨퍼런스에서 이례적인 입장을 했습니다."
      ],
      "marketInterpretation": [
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "Cathie Wood는 Palantir와 AMD를 판매한 후 Archer Aviation에 $ 3.35 백만을 쏟아 부었습니다.",
        "ARK가 플라잉 택시에 큰 베팅을 하나요?",
        "| The Motley Fool 접근성 도움말 회사 소개 ▲ S&P 500 + --- % | ▲ Stock Advisor + --- % The Motley Fool에 가입 1억 $ 이상의 투자를 받은 모든 회사는 보류 사실을 공시하는 13F 분기별 서류를 제출해야 합니다."
      ],
      "marketInterpretation": [
        "규제와 수출 제한은 매출 시장·제품 출하·비용을 동시에 바꿀 수 있어 공식 문서의 적용 범위를 확인해야 합니다.",
    ...
    },
    {
      ...
      "reportedClaims": [
        ...
        "Here is how Aehr Test Systems ( AEHR +3.25% ) and KLA ( KLAC +4.74% ) compare for investors."
      ],
      "marketInterpretation": [
        "규제와 수출 제한은 매출 시장·제품 출하·비용을 동시에 바꿀 수 있어 공식 문서의 적용 범위를 확인해야 합니다.",
        "이번 기사에서 확인된 구체적 수치: 3.25%, 4.74%, 70% — 공식 실적·가이던스와 일치하는지 확인이 필요합니다.",
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "버크셔 해서웨이 주식이 S&P 500 인덱스 펀드보다 더 나은 매수입니까?",
        "| Motley Fool 접근성 도움말 회사 소개 ▲ S&P 500 + --- % | ▲ 주식 어드바이저 + --- % Motley Fool에 가입 경험이 풍부한 투자자는 Vanguard S&P 500 ETF (VOO +0.11%) 와 같은 S&P 500 인덱스 펀드를 매수하고 보유할 때의 이점을 알고 있습니다. 또는",
        "매우 간단할 뿐만 아니라 통계적으로 말하자면 개별 주식을 선택하거나 적극적으로 관리되는 자금을 소유함으로써 더 나은 성과를 얻을 수 있습니다."
      ],
      "marketInterpretation": [
        "AI CAPEX 변화는 반도체·클라우드 수요와 투자 기업의 현금흐름을 서로 다른 방향으로 바꿀 수 있습니다.",
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "Inside the 200-Basis-Point Margin Gap Marvell Isn 't Talking About on Earnings Calls | TIKR.com 주식 리뷰 Inside the 200-Basis-Point Margin Gap Marvell Isn' t Talking About on Earnings Calls Gian Estrada • 8분 읽음 리뷰 작성자:",
        "Marvell의 GAAP 매출총이익률은 2027년 회계연도 2분기에 53.14% 를 기록하며 2년 연속 분기마다 증가했지만, GAAP 영업이익률은 같은 분기 18.66% 에서 14.48% 로 하락했습니다. Marvell은 천상 AI 인수와 관련된 비용을 흡수했습니다.",
        "44.76 배의 선행 수익에서 Marvell은 8 월에 공개 된 1,200 억 달러의 Google 맞춤 실리콘 보증이 회계 연도 20 이전에 거의 수익을 내지 못한다고 말하면서도 자체 3 년 평균 배수 인 35.2 배보다 27% 높은 $ 를 거래합니다."
      ],
      "marketInterpretation": [
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "워렌 버핏은 투자를 결정하기 전에 알파벳의 주가가 9,000% 오르는 것을 보았습니다.",
        "그와 그렉 아벨 (Greg Abel) 이 버크셔 해서웨이 (Berkshire Hathaway) 의 가장 큰 투자 중 하나가 된 이유는 다음과 같습니다.",
        "| The Motley Fool Accessibility Help About Us ▲ S&P 500 + --- % | ▲ Stock Advisor + --- % Join The Motley Fool 거의 10년 전에 Warren Buffett는 Berkshire Hathaway (BRKA -0.04%) (BRKB +0.11%) 투자자들에게 실수를 저질렀다고 말했습니다."
      ],
      "marketInterpretation": [
        "장기 계약은 매출 가시성을 높일 수 있지만 최소구매 의무·취소 조건·실제 인식 시점이 확인돼야 합니다.",
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "Oracle: 백로그 부담은 더 많은 Capex 고통을 암시합니다 - Contrarian AI Buy Thesis"
      ],
      "marketInterpretation": [],
      "aiInference": [
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "ARM Holdings는 여전히 AI 칩 레이스의 숨겨진 우승자입니까?",
        "| The Motley Fool Accessibility Help About Us ▲ S&P 500 + --- % | ▲ Stock Advisor + --- % Join The Motley Fool Arm Holdings (ARM +4.04%) 가 인공 지능 (AI) 퍼즐의 중요한 부분이라는 것은 비밀이 아닙니다.",
        "그러나 Arm을 최상위 AI 투자로 생각하는 빈도는 얼마나 됩니까?"
      ],
      "marketInterpretation": [
        "가이던스 변화는 다음 분기의 매출·EPS 컨센서스와 적정가 계산을 직접 바꿀 수 있습니다.",
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "Palantir 주식에 투자되는 $ 5,000는 5년 후 어떤 가치가 있을까요?",
        "콘텐츠로 건너뛰기 닫기 ❚❚ S&P 500 7,669.20 +0.30% Dow Jones 51,799.60 − 0.10% Nasdaq 100 29,701.00 +0.80% Russell 2000 2,862.20 − 0.42% S&P 500 7,669.20 +0.30% Dow Jones 51,799.60 − 0.10% Nasdaq 100 29,701.00 +0.80% Russell 2000 2,862.20 − 0.",
        "Palantir는 월스트리트가 눈을 비비는 40점의 규칙으로 전년 대비 90% 이상의 매출 성장을 기록했지만, 5년 모델은 황소 과대 광고가 암시하는 것보다 훨씬 더 복잡한 이야기를 들려줍니다."
      ],
      "marketInterpretation": [
        "목표주가 변경은 애널리스트의 EPS·PER 가정 변화이며 회사 공식 전망과는 구분해야 합니다.",
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "John Ternus의 첫 번째 iPhone 출시로 Bank of America 가격 목표 인하가 촉발되었습니다. Apple 주식은 매수인가요?"
      ],
      "marketInterpretation": [],
      "aiInference": [
        "사업·실적 연결 경로는 다음 공시에서 확인합니다."
    ...
    },
    {
      ...
      "reportedClaims": [
        "AI 데이터센터·반도체·전력·에너지저장 등으로 자금 공급 범위가 넓어지는 내용입니다.",
        "기사에서 언급된 규모: 0.26%, 90%, 2.43%, 18.7%, 0.63%, $1.6 Million, $10,000, $72,000.",
        "대출·투자은행·자본시장 조달 등 여러 방식의 자금 공급이 포함될 수 있습니다."
      ],
      "marketInterpretation": [
        "AI 투자가 빅테크 자체 자금뿐 아니라 금융기관·채권시장까지 동원하는 단계로 확장됐다는 의미입니다.",
    ...
    },
    {
      ...
      "reportedClaims": [
        "스파이: 실제로 다른 점이 있나요?",
        "| Motley Fool 접근성 도움말 회사 소개 ▲ S&P 500 + --- % | ▲ Stock Advisor + --- % Motley Fool에 가입 Vanguard S&P 500 ETF (VOO +0.11%) 와 State Street SPDR S&P 500 ETF (SPY +0.13%) 중에서 선택하려는 경우, i",
        "둘 다 거대하고 동일한 인덱스를 추적합니다."
      ],
      "marketInterpretation": [
        "AI CAPEX 변화는 반도체·클라우드 수요와 투자 기업의 현금흐름을 서로 다른 방향으로 바꿀 수 있습니다.",
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "Meta(META)의 Stilla.ai 거래로 비즈니스 에이전트를 새로운 수익화 엔진으로 전환할 수 있음"
      ],
      "marketInterpretation": [],
      "aiInference": [
        "사업·실적 연결 경로는 다음 공시에서 확인합니다."
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "Broadcom: 이러한 인공 지능 회사의 매출 성장 궤적 비교 | Motley Fool 접근성 도움말 회사 소개 ▲ S&P 500 + --- % | ▲ 스톡 어드바이저 + --- % Motley Fool 가입 응용 재료: 긍정으로 돌아 가기",
        "연구 생태계를 11건의 적극적인 업계 참여로 확대하고 스마트 안경용 광학 렌즈를 만들기 위한 공동 개발 계약을 발표하는 한편, 2026년 7월 26일 종료된 분기 동안 34% 의 영업이익률을 기록했다고 보고했습니다.",
        "Broadcom: 최근 분기 동안 총 매출 운영 확장 Broadcom (AVGO +2.97%) 은 고급 반도체 네트워킹 구성 요소 및 중요 인프라 소프트웨어 프로그램으로 구성된 매우 다양한 포트폴리오를 설계, 개발 및 공급합니다."
      ],
      "marketInterpretation": [
        "장기 계약은 매출 가시성을 높일 수 있지만 최소구매 의무·취소 조건·실제 인식 시점이 확인돼야 합니다.",
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "Palantir: 비즈니스는 성과를 내고 있지만, 가격은 여전히 너무 많이 요구합니다 (NASDAQ: PLTR) | 알파 요약 Palantir는 강력한 상업적 성장, 높은 영업이익률 및 현금 흐름 증가를 보여 주지만, 이미 평가가 진행 중입니다.",
        "PLTR의 경쟁 우위는 AI 기반 운영 논리를 클라이언트 워크플로우에 통합하여 높은 스위칭 비용과 장기적인 충성도를 창출하는 데 있습니다.",
        "인상적인 재무 상황에도 불구하고 PLTR의 프리미엄 평가는 채택이 둔화되거나 경쟁이 심화될 경우 오차 마진을 거의 남기지 않습니다."
      ],
      "marketInterpretation": [
        "규제와 수출 제한은 매출 시장·제품 출하·비용을 동시에 바꿀 수 있어 공식 문서의 적용 범위를 확인해야 합니다.",
        "PLTR의 다음 공시에서 기사 내용이 실제 숫자로 연결되는지 확인합니다."
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "Microsoft, Morgan Stanley가 수익률 전망을 강조하면서 분기별 배당 증가 | TIKR.com 일반 투자 Microsoft, Morgan Stanley가 수익률 전망을 강조하면서 분기별 배당 증가 Aditya Raghunath • 4분 읽음 리뷰 작성자: D",
        "17: $ 498 52주 최고: $ 554 $ MSFT 주가 목표: $ 573 현재 라이브: TIKR의 새로운 가치 평가 모델을 사용하여 좋아하는 주식의 상승폭을 알아보세요 (무료) > > > 무슨 일이 일어났나요?",
        "Microsoft (MSFT) 주식은 회사가 분기별 배당금을 전분기 대비 8% 증가한 주당 $ 0.98 로 인상한 후 초점을 맞추고 있습니다."
      ],
      "marketInterpretation": [
        "목표주가 변경은 애널리스트의 EPS·PER 가정 변화이며 회사 공식 전망과는 구분해야 합니다.",
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "Alphabet의 광고 사업은 주요 독점금지 판결에서 힘을 얻어 Google이 10년 만에 최악의 연속 적자를 종식하는 데 도움이 되었습니다. Sundar Pichai의 알파벳 주식은 지금 구매됩니까?"
      ],
      "marketInterpretation": [],
      "aiInference": [
        "사업·실적 연결 경로는 다음 공시에서 확인합니다."
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "2027년까지의 부족에 대한 Micron Technology(MU) 경고는 무엇을 의미합니까?"
      ],
      "marketInterpretation": [],
      "aiInference": [
        "사업·실적 연결 경로는 다음 공시에서 확인합니다."
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "SPMO는 S&P 500의 가장 빠르게 상승하는 주식 100주를 소유하고 있습니다.",
        "그 모멘텀 화면은 지난 5 년 동안 67 포인트 지수를 이겼습니다 - 24/7 Wall St.",
        "콘텐츠로 건너뛰기 닫기 ❚❚ S&P 500 7,669.20 +0.30% Dow Jones 51,799.60 − 0.10% Nasdaq 100 29,701.00 +0.80% Russell 2000 2,862.20 − 0.42% S&P 500 7,669.20 +0.30% Dow Jones 51,799.60 − 0.10% Nasdaq 100 29,701.00 +0.80% Russell 2000 2,862.20 − 0."
      ],
      "marketInterpretation": [
        "AI CAPEX 변화는 반도체·클라우드 수요와 투자 기업의 현금흐름을 서로 다른 방향으로 바꿀 수 있습니다.",
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "Jim Cramer는 자신의 Palantir Technologies Inc.(NASDAQ:PLTR) 목표 가격이 250달러라고 말합니다."
      ],
      "marketInterpretation": [],
      "aiInference": [
        "사업·실적 연결 경로는 다음 공시에서 확인합니다."
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "S&P 500 수익: 분기별 S&P 500 EPS 추정치는 주당 100달러를 기록합니다."
      ],
      "marketInterpretation": [],
      "aiInference": [
        "사업·실적 연결 경로는 다음 공시에서 확인합니다."
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "퀄컴, 지난 달 집회에서 긴장이 풀리면서 6% 하락, 스카이웍스와 코르보 슬립 - 24/7 Wall St.",
        "콘텐츠로 건너뛰기 닫기 ❚❚ S&P 500 7,669.20 +0.30% Dow Jones 51,799.60 − 0.10% Nasdaq 100 29,701.00 +0.80% Russell 2000 2,862.20 − 0.42% S&P 500 7,669.20 +0.30% Dow Jones 51,799.60 − 0.10% Nasdaq 100 29,701.00 +0.80% Russell 2000 2,862.20 − 0.",
        "By 데이비드 모아델 Published September 18, 2026, 1:58 pm ET · 4 min read Market Movers desk."
      ],
      "marketInterpretation": [
        "신주·워런트는 회사 자금을 늘리지만 기존 주주의 지분과 주당 이익을 희석할 수 있습니다.",
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "ARM: 2026년에는 어떤 AI 기반 기술 주식을 구매하는 것이 더 좋을까요?",
        "| The Motley Fool 접근성 도움말 회사 소개 ▲ S&P 500 + --- % | ▲ Stock Advisor + --- % Motley Fool에 가입 인공 지능 구축이 다음 단계로 접어들면서 투자자들은 Astera Labs (ALAB +3) 의 폭발적인 성장에 무게를 두고 있습니다.",
        "Astera Labs는 AI 칩이 통신할 수 있는 중요한 하드웨어 링크를 제공하는 반면, Arm은 이러한 칩을 설계하는 데 사용되는 기본 아키텍처 청사진을 제공합니다."
      ],
      "marketInterpretation": [
        "부품 부족과 생산 지연은 출하량·재고·마진에 순차적으로 반영될 수 있습니다.",
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "GlobalFoundries, Marvell 계약 확대로 7% 상승"
      ],
      "marketInterpretation": [],
      "aiInference": [
        "사업·실적 연결 경로는 다음 공시에서 확인합니다."
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "Prediction: Seagate Could Be a Surprisingly Big Winner From the AI Boom - 24/7 Wall St.",
        ...
        "The real question is whether the forces driving that run have staying power… By Vandita Jadeja Published September 18, 2026, 12:00pm ET · 3 min read Price Targets desk."
      ],
      "marketInterpretation": [
        "목표주가 변경은 애널리스트의 EPS·PER 가정 변화이며 회사 공식 전망과는 구분해야 합니다.",
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "SiGe 용량 확장을 위한 GFS의 Marvell 거래가 성장을 가속화할 수 있습니까?"
      ],
      "marketInterpretation": [],
      "aiInference": [
        "사업·실적 연결 경로는 다음 공시에서 확인합니다."
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "대만 반도체 제조(TSM)가 2nm 생산을 늘리고 더 많은 비용을 지출하는 이유는 무엇입니까?"
      ],
      "marketInterpretation": [],
      "aiInference": [
        "사업·실적 연결 경로는 다음 공시에서 확인합니다."
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "Constellation Energy Is Down 29% From Its Peak.",
        "Is the Nuclear Bull Case Still Intact?",
        "| TIKR.com Stock Reviews Constellation Energy Is Down 29% From Its Peak."
      ],
      "marketInterpretation": [
        "목표주가 변경은 애널리스트의 EPS·PER 가정 변화이며 회사 공식 전망과는 구분해야 합니다.",
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "Seagate’s Gross Margin Hit 52.7% Last Quarter.",
        "Here&#8217;s Why the CFO Says It Holds | TIKR.com Stock Reviews Seagate’s Gross Margin Hit 52.7% Last Quarter.",
        "Here’s Why the CFO Says It Holds Wiltone Asuncion • 8 minute read Reviewed by: David Hanson Last updated Sep 17, 2026 @panumas nikhomkhai from Pexels via Canva, @panumas nikhomkhai from Pexels via Canva K ey Stats for Seagate Stock Current "
      ],
      "marketInterpretation": [
        "목표주가 변경은 애널리스트의 EPS·PER 가정 변화이며 회사 공식 전망과는 구분해야 합니다.",
    ...
    },
    {
      ...
      "impactProbability": "보통",
      "verificationStatus": "needs_confirmation",
      "headline": "EMCOR Group, Inc. (EME) Presents at Morgan Stanley's 14th Annual Laguna Conference Transcript",
      "headlineKo": "EMCOR Group, Inc.(EME), Morgan Stanley의 제14차 연례 Laguna 컨퍼런스 성적표에서 발표",
      "source": {
        "name": "SeekingAlpha",
        "url": "https://finnhub.io/api/news?id=c62cb844835d5b54809bfeb0492b02909417ef3571d5c4f1fc5ac8d2c9815849",
        "publishedAt": 1789653528,
        "collectedAt": 1789886496.476168
      },
      "confirmedFacts": [],
      "reportedClaims": [
        "(EME) Presents at Morgan Stanley's 14th Annual Laguna Conference Transcript | Seeking Alpha EMCOR Group, Inc.",
        "( EME ) Morgan Stanley's 14th Annual Laguna Conference September 17, 2026 10:45 AM EDT Company Participants Anthony Guzzi - Chairman, President & CEO Jason Nalbandian - Senior VP, CFO & Chief Accounting Officer Conference Call Participants ",
        "My name is Stefan Diaz, machinery and construction analyst here at Morgan Stanley."
      ],
      "marketInterpretation": [
        "AI CAPEX 변화는 반도체·클라우드 수요와 투자 기업의 현금흐름을 서로 다른 방향으로 바꿀 수 있습니다.",
      ...
      "aiInference": [
        "EME에 대한 AI 투자 변화 · 수요와 현금 부담 뉴스입니다. 현재 확인된 기사 내용이 매출·EPS·영업이익률에 어떤 영향을 주는지 다음 공시와 비교합니다."
      ],
      "unverified": [
        "기사의 계약 금액·워런트 규모·목표주가·거래 수치는 회사 공시 또는 규제기관 원문으로 재확인해야 합니다."
      ],
    ...
    },
    {
      ...
      "aiInference": [
        "이 기사는 AAPL의 사업과 관련된 'Apple iPhone Demand Should Hold Up On Higher Carrier Incentives, BofA Says' 이슈입니다. 기사에 나온 전망은 아직 회사가 공시한 실적이 아니므로, 뉴스 → 매출·EPS·영업이익률 → 주가 반영 순서로 확인해야 합니다."
      ],
      "unverified": [
        "기사의 계약 금액·워런트 규모·목표주가·거래 수치는 회사 공시 또는 규제기관 원문으로 재확인해야 합니다."
      ],
    ...
    },
    {
      ...
      "marketInterpretation": [
        "장기 계약은 매출 가시성을 높일 수 있지만 최소구매 의무·취소 조건·실제 인식 시점이 확인돼야 합니다.",
        "이번 기사에서 확인된 구체적 수치: 0.49%, 4.81%, 19% — 공식 실적·가이던스와 일치하는지 확인이 필요합니다.",
        "MRVL의 다음 공시에서 기사 내용이 실제 숫자로 연결되는지 확인합니다."
      ],
      "aiInference": [
    ...
    },
    {
      ...
      "reportedClaims": [
        ...
        "Broadcom(AVGO +2.29%)의 2026년 2분기 수익이 예상치를 상회했음에도 불구하고 경영진의 수익 지침은 이미 칩 부문의 전망에 대해 전반적으로 불확실함을 느끼고 있던 투자자들을 실망시켰습니다.",
        "그럼에도 불구하고 급격한 매출 및 순익 성장과 높은 가치 평가로 인해 Broadcom은 지난 5년 동안 거의 600% 상승했습니다."
      ],
      "marketInterpretation": [
        "가이던스 변화는 다음 분기의 매출·EPS 컨센서스와 적정가 계산을 직접 바꿀 수 있습니다.",
        "이번 기사에서 확인된 구체적 수치: 2.29%, 600%, 2.54% — 공식 실적·가이던스와 일치하는지 확인이 필요합니다.",
        "AVGO의 다음 공시에서 기사 내용이 실제 숫자로 연결되는지 확인합니다."
      ],
      "aiInference": [
        "AVGO에 대한 회사 전망 변경 · 추정치 재평가 뉴스입니다. 현재 확인된 기사 내용이 매출·EPS·영업이익률에 어떤 영향을 주는지 다음 공시와 비교합니다."
    ...
    },
    {
      ...
      "aiInference": [
        "AMAT에 대한 공급망 · 생산 차질 확인 뉴스입니다. 현재 확인된 기사 내용이 판매량·ASP(평균판매가격)·매출총이익률에 어떤 영향을 주는지 다음 공시와 비교합니다."
      ],
      "unverified": [
        "기사의 계약 금액·워런트 규모·목표주가·거래 수치는 회사 공시 또는 규제기관 원문으로 재확인해야 합니다."
      ],
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "Generac 주가는 Amazon 데이터 센터 공급 계약 발표 후 33.7% 급등"
      ],
      "marketInterpretation": [],
      "aiInference": [
        "사업·실적 연결 경로는 다음 공시에서 확인합니다."
    ...
    },
    {
      ...
      "aiInference": [
        "이 기사는 ORCL의 사업과 관련된 'Oracle: Dismiss The Overblown Credit Fears' 이슈입니다. 기사에 나온 전망은 아직 회사가 공시한 실적이 아니므로, 뉴스 → 다음 실적의 매출·이익·현금흐름 → 주가 반영 순서로 확인해야 합니다."
      ],
      "unverified": [
        "기사의 계약 금액·워런트 규모·목표주가·거래 수치는 회사 공시 또는 규제기관 원문으로 재확인해야 합니다."
      ],
    ...
    },
    {
      ...
      "aiInference": [
        "이 기사는 GOOGL의 사업과 관련된 'Mark Cuban Says Meta and Google Could Be Funding Their AI Future With Anti-Tech Content: 'Interesting to Watch the Irony…'' 이슈입니다. 기사에 나온 전망은 아직 회사가 공시한 실적이 아니므로, 뉴스 → 다음 실적의 매출·이익·현금흐름 → 주가 반영 순서로 확인해야 합니다."
      ],
      "unverified": [
        "기사의 계약 금액·워런트 규모·목표주가·거래 수치는 회사 공시 또는 규제기관 원문으로 재확인해야 합니다."
      ],
    ...
    },
    {
      ...
      "source": {
        ...
        "publishedAt": 1789637620,
        "collectedAt": 1789886496.476168
      },
      "confirmedFacts": [],
      "reportedClaims": [
        "씨티그룹, Salesforce 중립 유지, 목표 가격 263달러로 인상"
      ],
      "marketInterpretation": [],
      "aiInference": [
        "사업·실적 연결 경로는 다음 공시에서 확인합니다."
    ...
    },
    {
      ...
      "source": {
        ...
        "publishedAt": 1789637363,
        "collectedAt": 1789886496.476168
      },
      "confirmedFacts": [],
      "reportedClaims": [
        "RBC Capital, Salesforce에서 부문별 실적을 유지하고 목표 가격 250달러 유지"
      ],
      "marketInterpretation": [],
      "aiInference": [
        "사업·실적 연결 경로는 다음 공시에서 확인합니다."
    ...
    },
    {
      ...
      "aiInference": [
        "이 기사는 GOOGL의 사업과 관련된 'Market Chatter: Blackstone, Alphabet AI Venture Set for $22 Billion Chip Financing' 이슈입니다. 기사에 나온 전망은 아직 회사가 공시한 실적이 아니므로, 뉴스 → 다음 실적의 매출·이익·현금흐름 → 주가 반영 순서로 확인해야 합니다."
      ],
      "unverified": [
        "기사의 계약 금액·워런트 규모·목표주가·거래 수치는 회사 공시 또는 규제기관 원문으로 재확인해야 합니다."
      ],
    ...
    },
    {
      ...
      "impactProbability": "보통",
      "verificationStatus": "needs_confirmation",
      "headline": "Arm CEO Expresses Confidence in Data Center CPU Revenue Demand",
      "headlineKo": "Arm CEO, 데이터센터 CPU 매출 수요에 자신감 표명",
      "source": {
        "name": "Yahoo",
        "url": "https://finnhub.io/api/news?id=52b636ad16c60032b80c3e65bd187427d89b9f1f6491fab538a8c4d076c24368",
        "publishedAt": 1789635080,
        "collectedAt": 1789886496.476168
      },
      "confirmedFacts": [],
      "reportedClaims": [
        "Arm CEO, 데이터센터 CPU 매출 수요에 자신감 표명"
      ],
      "marketInterpretation": [],
      "aiInference": [
        "사업·실적 연결 경로는 다음 공시에서 확인합니다."
    ...
    },
    {
      ...
      "source": {
        ...
        "publishedAt": 1789634820,
        "collectedAt": 1789886496.476168
      },
      "confirmedFacts": [],
      "reportedClaims": [
        "어드밴텍, Intel, Qualcomm, AMD를 통해 WEDA 기반 엣지 AI 생태계 확장"
      ],
      "marketInterpretation": [],
      "aiInference": [
        "사업·실적 연결 경로는 다음 공시에서 확인합니다."
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "Microsoft 거래가 AI 네트워크 추진을 심화함에 따라 Nokia 주가 급등"
      ],
      "marketInterpretation": [],
      "aiInference": [
        "사업·실적 연결 경로는 다음 공시에서 확인합니다."
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "GlobalFoundries와 Marvell Technology는 광 연결에 대한 수요를 지원하기 위해 버몬트주 벌링턴 시설에서 GFS의 실리콘 게르마늄 기술 용량을 늘리기 위해 다년 계약을 확장합니다."
      ],
      "marketInterpretation": [],
      "aiInference": [
        "사업·실적 연결 경로는 다음 공시에서 확인합니다."
    ...
    },
    {
      ...
      "aiInference": [
        "이 기사는 AAPL의 사업과 관련된 'Intel Stock Could Nearly Double to $200 in 2 Years, Analyst Says — Potential Apple, Tesla, and AI Chip Deals Could Fuel the Rally' 이슈입니다. 기사에 나온 전망은 아직 회사가 공시한 실적이 아니므로, 뉴스 → 다음 실적의 매출·이익·현금흐름 → 주가 반영 순서로 확인해야 합니다."
      ],
      "unverified": [
        "기사의 계약 금액·워런트 규모·목표주가·거래 수치는 회사 공시 또는 규제기관 원문으로 재확인해야 합니다.",
        "현재 캐시는 제목 또는 제한된 본문을 기반으로 하므로 세부 조건을 확정 사실로 저장하지 않습니다."
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "Google과 Stegra가 환경 속성 인증서에 대해 계약을 체결했습니다."
      ],
      "marketInterpretation": [],
      "aiInference": [
        "사업·실적 연결 경로는 다음 공시에서 확인합니다."
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "Surf Air Mobility는 Palantir가 제공하는 Part 135 운영자를 위한 Surf Air Mobility의 SurfOS 비행 운영 소프트웨어인 OperatorOS에 대해 Sprintbach와 최종 계약을 체결했습니다."
      ],
      "marketInterpretation": [],
      "aiInference": [
        "사업·실적 연결 경로는 다음 공시에서 확인합니다."
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "성능 비교: 기술 하드웨어, 스토리지 및 주변 장치 산업의 Apple과 경쟁업체"
      ],
      "marketInterpretation": [],
      "aiInference": [
        "사업·실적 연결 경로는 다음 공시에서 확인합니다."
    ...
    },
    {
      ...
      "aiInference": [
        "PLTR에 대한 공급망 · 생산 차질 확인 뉴스입니다. 현재 확인된 기사 내용이 매출·EPS·영업이익률에 어떤 영향을 주는지 다음 공시와 비교합니다."
      ],
      "unverified": [
        "기사의 계약 금액·워런트 규모·목표주가·거래 수치는 회사 공시 또는 규제기관 원문으로 재확인해야 합니다."
      ],
    ...
    },
    {
      ...
      "reportedClaims": [
        ...
        "신규 에이전트 연결 트렌드 뉴스 수입 전체 DIA 0.44% SPY 1.01% QQQ 1.81% Trending QQQ 1.81% SPY 1.01% GME 4.00% PURR 18.36% ARB 36.49% UNI 28.36% BB 5.24% PEP 0.33% SDGR 24.40% CRWV 3.26% 홈 뉴스 시장 주식 왜 BE, FCEL, GE인가요?",
        "BE, FCEL, GEV 주식이 밤새 상승하는 이유는 무엇입니까?"
      ],
      "marketInterpretation": [
        "규제와 수출 제한은 매출 시장·제품 출하·비용을 동시에 바꿀 수 있어 공식 문서의 적용 범위를 확인해야 합니다.",
        "이번 기사에서 확인된 구체적 수치: 0.44%, 1.01%, 1.81% — 공식 실적·가이던스와 일치하는지 확인이 필요합니다.",
        "GEV의 다음 공시에서 기사 내용이 실제 숫자로 연결되는지 확인합니다."
      ],
      "aiInference": [
    ...
    },
    {
      ...
      "aiInference": [
        "이 기사는 NVDA의 사업과 관련된 'Micron vs. Sandisk: Which AI Memory Stock Benefits More From Nvidia's $279 Billion Warning?' 이슈입니다. 기사에 나온 전망은 아직 회사가 공시한 실적이 아니므로, 뉴스 → 매출·EPS·영업이익률 → 주가 반영 순서로 확인해야 합니다."
      ],
      "unverified": [
        "기사의 계약 금액·워런트 규모·목표주가·거래 수치는 회사 공시 또는 규제기관 원문으로 재확인해야 합니다."
      ],
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "Talen Energy: 어떤 핵 비중이 높은 주식이 더 나은 AI 파워 베팅인가?",
        "| Motley Fool 접근성 도움말 회사 소개 ▲ S&P 500 + ---% | ▲ Stock Advisor + ---% Join The Motley Fool Advanced 칩은 Nvidia 및 기타 업체의 뛰어난 컴퓨팅 성능을 제공하지만 막대한 양의 전력을 소비합니다.",
        "결과적으로 하이퍼스케일러는 이러한 데이터 센터가 온라인 상태가 되면서 안정적인 전력을 찾기 위해 온갖 노력을 기울이고 있습니다."
      ],
      "marketInterpretation": [
        "AI CAPEX 변화는 반도체·클라우드 수요와 투자 기업의 현금흐름을 서로 다른 방향으로 바꿀 수 있습니다.",
        "이번 기사에서 확인된 구체적 수치: 1.31%, 2.28%, 0.17% — 공식 실적·가이던스와 일치하는지 확인이 필요합니다.",
        "CEG의 다음 공시에서 기사 내용이 실제 숫자로 연결되는지 확인합니다."
      ],
      "aiInference": [
        "CEG에 대한 AI 투자 변화 · 수요와 현금 부담 뉴스입니다. 현재 확인된 기사 내용이 판매량·ASP(평균판매가격)·매출총이익률에 어떤 영향을 주는지 다음 공시와 비교합니다."
      ],
      "unverified": [
        "기사의 계약 금액·워런트 규모·목표주가·거래 수치는 회사 공시 또는 규제기관 원문으로 재확인해야 합니다."
      ],
    ...
    },
    {
      ...
      "aiInference": [
        "이 기사는 CRM의 사업과 관련된 'Salesforce Investor Day Unveils AIforce, Claudeforce and $63B FY2030 Revenue Target' 이슈입니다. 기사에 나온 전망은 아직 회사가 공시한 실적이 아니므로, 뉴스 → 매출·EPS·영업이익률 → 주가 반영 순서로 확인해야 합니다."
      ],
      "unverified": [
        "기사의 계약 금액·워런트 규모·목표주가·거래 수치는 회사 공시 또는 규제기관 원문으로 재확인해야 합니다."
      ],
    ...
    },
    {
      ...
      "aiInference": [
        "이 기사는 NVDA의 사업과 관련된 'More Than a Quarter of Nvidia's Revenue Now Comes From Customers Based in Taiwan. Should Investors Be Worried?' 이슈입니다. 기사에 나온 전망은 아직 회사가 공시한 실적이 아니므로, 뉴스 → 매출·EPS·영업이익률 → 주가 반영 순서로 확인해야 합니다."
      ],
      "unverified": [
        "기사의 계약 금액·워런트 규모·목표주가·거래 수치는 회사 공시 또는 규제기관 원문으로 재확인해야 합니다."
      ],
    ...
    },
    {
      ...
      "aiInference": [
        "이 기사는 TSLA의 사업과 관련된 'Billionaire Ron Baron is Extremely Bullish on Tesla Stock. What’s His Reason?' 이슈입니다. 기사에 나온 전망은 아직 회사가 공시한 실적이 아니므로, 뉴스 → 다음 실적의 매출·이익·현금흐름 → 주가 반영 순서로 확인해야 합니다."
      ],
      "unverified": [
        "기사의 계약 금액·워런트 규모·목표주가·거래 수치는 회사 공시 또는 규제기관 원문으로 재확인해야 합니다."
      ],
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "Nvidia가 Miner와 55억 달러 규모의 AI 클라우드 거래를 성사시킨 후 IREN(IREN)이 6.1% 하락한 이유"
      ],
      "marketInterpretation": [],
      "aiInference": [
        "사업·실적 연결 경로는 다음 공시에서 확인합니다."
    ...
    },
    {
      ...
      "impactProbability": "보통",
      "verificationStatus": "needs_confirmation",
      "headline": "Lumentum Stock Is Up Nearly 10% This Week. Here’s the Case for 27.5% Annual Returns",
      "headlineKo": "Lumentum 주식은 이번 주에 거의 10% 상승했습니다. 연간 수익률 27.5%의 사례는 다음과 같습니다.",
      "source": {
        "name": "Yahoo",
        "url": "https://finnhub.io/api/news?id=e8e39f5c4292a024471f39afa2f5538551721eca6f7144818d3e3ad07644b4e0",
        "publishedAt": 1789602635,
        "collectedAt": 1789886496.476168
      },
      "confirmedFacts": [],
      "reportedClaims": [
        "Lumentum Stock Is Up Nearly 10% This Week.",
        "Here&#8217;s the Case for 27.5% Annual Returns | TIKR.com Stock Reviews Lumentum Stock Is Up Nearly 10% This Week.",
        "Here’s the Case for 27.5% Annual Returns Rexielyn Diaz • 6 minute read Reviewed by: David Hanson Last updated Sep 16, 2026 Avalon_Studio from Getty Images Signature and Tiero via Canva Key Stats for LITE Stock Past week performance: +9.6% 5"
      ],
      "marketInterpretation": [
        "목표주가 변경은 애널리스트의 EPS·PER 가정 변화이며 회사 공식 전망과는 구분해야 합니다.",
        "이번 기사에서 확인된 구체적 수치: 10%, 27.5%, 9.6% — 공식 실적·가이던스와 일치하는지 확인이 필요합니다.",
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "AI 업계에 대한 Salesforce의 Marc Benioff: 규제하지 않으면 고소당함"
      ],
      "marketInterpretation": [],
      "aiInference": [
        "사업·실적 연결 경로는 다음 공시에서 확인합니다."
    ...
    },
    {
      ...
      "aiInference": [
        "이 기사는 GOOGL의 사업과 관련된 'GOOGL, BX Stock In Focus — Banking Consortium Reportedly Lines Up $22B AI Chip Financing For Blackstone-Alphabet Venture' 이슈입니다. 기사에 나온 전망은 아직 회사가 공시한 실적이 아니므로, 뉴스 → 매출·EPS·영업이익률 → 주가 반영 순서로 확인해야 합니다."
      ],
      "unverified": [
        "기사의 계약 금액·워런트 규모·목표주가·거래 수치는 회사 공시 또는 규제기관 원문으로 재확인해야 합니다."
      ],
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "Generac 주가는 80억 달러 규모의 Amazon 공급 계약으로 18% 급등"
      ],
      "marketInterpretation": [],
      "aiInference": [
        "사업·실적 연결 경로는 다음 공시에서 확인합니다."
    ...
    },
    {
      ...
      "source": {
        ...
        "publishedAt": 1789588577,
        "collectedAt": 1789886496.476168
      },
      "confirmedFacts": [],
      "reportedClaims": [
        "Figma: 2026년에 구매할 더 나은 고성장 소프트웨어 주식 평가 | Motley Fool 접근성 도움말 회사 소개 ▲ S&P 500 + ---% | ▲ Stock Advisor + ---% Motley Fool Investors에 참여하세요. 기존 거대 기업과 H 사이에서 자주 토론하는",
        "2026년에 Salesforce(CRM -2.00%)와 Figma(FIG -3.43%) 중 하나를 선택하면 입증된 수익성과 비용이 많이 들지만 폭발적인 확장 사이의 균형이 강조됩니다.",
        "Salesforce는 전 세계 150,000개 이상의 기업에 서비스를 제공하는 클라우드 기반 고객 관계 관리(CRM) 분야의 지배적인 리더로 남아 있습니다."
      ],
      "marketInterpretation": [
        "AI CAPEX 변화는 반도체·클라우드 수요와 투자 기업의 현금흐름을 서로 다른 방향으로 바꿀 수 있습니다.",
        "이번 기사에서 확인된 구체적 수치: 2.00%, 3.43%, 10% — 공식 실적·가이던스와 일치하는지 확인이 필요합니다.",
        "CRM의 다음 공시에서 기사 내용이 실제 숫자로 연결되는지 확인합니다."
      ],
      "aiInference": [
        "CRM에 대한 AI 투자 변화 · 수요와 현금 부담 뉴스입니다. 현재 확인된 기사 내용이 매출·EPS·영업이익률에 어떤 영향을 주는지 다음 공시와 비교합니다."
    ...
    },
    {
      ...
      "aiInference": [
        "이 기사는 PWR의 사업과 관련된 'Quanta Services Has A $53 Billion AI Power Backlog' 이슈입니다. 기사에 나온 전망은 아직 회사가 공시한 실적이 아니므로, 뉴스 → 다음 실적의 매출·이익·현금흐름 → 주가 반영 순서로 확인해야 합니다."
      ],
      "unverified": [
        "기사의 계약 금액·워런트 규모·목표주가·거래 수치는 회사 공시 또는 규제기관 원문으로 재확인해야 합니다."
      ],
    ...
    },
    {
      ...
      "impactProbability": "보통",
      "verificationStatus": "needs_confirmation",
      "headline": "CIEN Targets 30% Revenue Growth Through 2029 — Peers COHR, GLW And AAOI Rally After Guidance",
      "headlineKo": "CIEN, 2029년까지 30% 수익 성장 목표 — 지침 후 동료 COHR, GLW 및 AAOI 랠리",
      "source": {
        "name": "Yahoo",
        "url": "https://finnhub.io/api/news?id=631f7fade29f95dfc76ce44ccaa4c73ba9a11fd4b252188b6feaf111dbdb9cd7",
        "publishedAt": 1789586253,
        "collectedAt": 1789886496.476168
      },
      "confirmedFacts": [],
      "reportedClaims": [
        "CIEN은 2029년까지 30%의 수익 성장을 목표로 합니다 — 지침에 따라 동료 COHR, GLW 및 AAOI가 랠리를 펼칩니다 New 에이전트 연결 트렌드 뉴스 수익 전체 DIA 0.62% SPY 1.10% QQQ 1.68% Trending RARE 15.84% DKNG 7.52% GME 3.59% HELP 12.32% ZEC 12.71% AB",
      ...
      "marketInterpretation": [
        "가이던스 변화는 다음 분기의 매출·EPS 컨센서스와 적정가 계산을 직접 바꿀 수 있습니다.",
        "이번 기사에서 확인된 구체적 수치: 30%, 0.62%, 1.10% — 공식 실적·가이던스와 일치하는지 확인이 필요합니다.",
        "COHR의 다음 공시에서 기사 내용이 실제 숫자로 연결되는지 확인합니다."
      ],
      "aiInference": [
    ...
    },
    {
      ...
      "impactProbability": "보통",
      "verificationStatus": "needs_confirmation",
      "headline": "Salesforce’s $25 Billion Buyback Is Looking Like A Great Deal. Cramer Says “Whatever Was Ailing The Stock Is Over”",
      "headlineKo": "Salesforce의 250억 달러 규모의 자사주 매입은 매우 좋은 거래처럼 보입니다. Cramer는 \"주식을 악화시키는 것은 무엇이든 끝났습니다\"라고 말합니다.",
      "source": {
        "name": "Yahoo",
        "url": "https://finnhub.io/api/news?id=1d39edd30a8d7ccaf87b457a81b7a98941975aebc2a2ad0c7c1a9442405a9363",
      ...
      "reportedClaims": [
        "AI 데이터센터·반도체·전력·에너지저장 등으로 자금 공급 범위가 넓어지는 내용입니다.",
        "기사에서 언급된 규모: $25 Billion, $25 billion, $176, 14%, $251.59, 1.59%, $255.65,, 4.53%.",
        "대출·투자은행·자본시장 조달 등 여러 방식의 자금 공급이 포함될 수 있습니다."
      ],
      "marketInterpretation": [
        "AI 투자가 빅테크 자체 자금뿐 아니라 금융기관·채권시장까지 동원하는 단계로 확장됐다는 의미입니다.",
      ...
      "aiInference": [
        "이 기사는 CRM의 사업과 관련된 'Salesforce’s $25 Billion Buyback Is Looking Like A Great Deal. Cramer Says “Whatever Was Ailing The Stock Is Over”' 이슈입니다. 기사에 나온 전망은 아직 회사가 공시한 실적이 아니므로, 뉴스 → 매출·EPS·영업이익률 → 주가 반영 순서로 확인해야 합니다."
      ],
      "unverified": [
        "기사의 계약 금액·워런트 규모·목표주가·거래 수치는 회사 공시 또는 규제기관 원문으로 재확인해야 합니다."
      ],
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "GE Vernova rebounds 6% after earlier sell-off What are you searching for?",
        "Companies News See all companies matching See all news matching Utilities Power & Utilities Edited by: Angela Harmantas Disclaimer No investment advice About this content Editorial Standards & Policies Share article About this content × Abo",
        "All our content is produced independently by our experienced and qualified teams of news journalists."
      ],
      "marketInterpretation": [
        "장기 계약은 매출 가시성을 높일 수 있지만 최소구매 의무·취소 조건·실제 인식 시점이 확인돼야 합니다.",
        "이번 기사에서 확인된 구체적 수치: 6%, $933.94, 1.24% — 공식 실적·가이던스와 일치하는지 확인이 필요합니다.",
        "GEV의 다음 공시에서 기사 내용이 실제 숫자로 연결되는지 확인합니다."
      ],
      "aiInference": [
        "GEV에 대한 장기 공급계약 · 매출 가시성 확인 뉴스입니다. 현재 확인된 기사 내용이 비용·CAPEX·영업현금흐름·FCF·부채에 어떤 영향을 주는지 다음 공시와 비교합니다."
      ],
      "unverified": [
        "기사의 계약 금액·워런트 규모·목표주가·거래 수치는 회사 공시 또는 규제기관 원문으로 재확인해야 합니다."
      ],
    ...
    },
    {
      ...
      "impactProbability": "보통",
      "verificationStatus": "needs_confirmation",
      "headline": "Prediction: $1,000 Invested in Taiwan Semiconductor (TSMC) Today Will Be Worth This Much by the End of the Decade",
      "headlineKo": "예측: 현재 대만 반도체(TSMC)에 투자된 1,000달러의 가치는 10년 말까지 이만큼 가치가 있을 것입니다.",
      "source": {
        "name": "Yahoo",
        "url": "https://finnhub.io/api/news?id=db035b591ca8903280685f01b101a1217a2745dd6d71144f697a151f9c7e4279",
      ...
      "reportedClaims": [
        "AI 데이터센터·반도체·전력·에너지저장 등으로 자금 공급 범위가 넓어지는 내용입니다.",
        "기사에서 언급된 규모: $1,000, $1,750, $2,000, 3.00 %, $ 12.54, $ 430.26, $2.2, $ 423.39.",
        "대출·투자은행·자본시장 조달 등 여러 방식의 자금 공급이 포함될 수 있습니다."
      ],
      "marketInterpretation": [
        "AI 투자가 빅테크 자체 자금뿐 아니라 금융기관·채권시장까지 동원하는 단계로 확장됐다는 의미입니다.",
      ...
      "aiInference": [
        "이 기사는 TSM의 사업과 관련된 'Prediction: $1,000 Invested in Taiwan Semiconductor (TSMC) Today Will Be Worth This Much by the End of the Decade' 이슈입니다. 기사에 나온 전망은 아직 회사가 공시한 실적이 아니므로, 뉴스 → 매출·EPS·영업이익률 → 주가 반영 순서로 확인해야 합니다."
      ],
      "unverified": [
        "기사의 계약 금액·워런트 규모·목표주가·거래 수치는 회사 공시 또는 규제기관 원문으로 재확인해야 합니다."
      ],
    ...
    },
    {
      ...
      "source": {
        "name": "Yahoo",
        "url": "https://finnhub.io/api/news?id=909448f4a4bcbd588d61984ed35221ede0ff8f150c1d7da69e97382a6158c4bf",
        "publishedAt": 1789581485,
        "collectedAt": 1789886496.476168
      },
      "confirmedFacts": [],
      "reportedClaims": [
    ...
    },
    {
      ...
      "aiInference": [
        "AMD에 대한 내부자 매도 · 맥락 확인 뉴스입니다. 현재 확인된 기사 내용이 매출·EPS·영업이익률에 어떤 영향을 주는지 다음 공시와 비교합니다."
      ],
      "unverified": [
        "기사의 계약 금액·워런트 규모·목표주가·거래 수치는 회사 공시 또는 규제기관 원문으로 재확인해야 합니다."
      ],
    ...
    },
    {
      ...
      "aiInference": [
        "이 기사는 ORCL의 사업과 관련된 'Oracle Rallies 2% as Restructuring Helps Finance the AI Sprint' 이슈입니다. 기사에 나온 전망은 아직 회사가 공시한 실적이 아니므로, 뉴스 → 다음 실적의 매출·이익·현금흐름 → 주가 반영 순서로 확인해야 합니다."
      ],
      "unverified": [
        "기사의 계약 금액·워런트 규모·목표주가·거래 수치는 회사 공시 또는 규제기관 원문으로 재확인해야 합니다."
      ],
    ...
    },
    {
      ...
      "aiInference": [
        "이 기사는 AMZN의 사업과 관련된 'Qualcomm Edged Higher as Amazon Opens a $60 Billion AI Door' 이슈입니다. 기사에 나온 전망은 아직 회사가 공시한 실적이 아니므로, 뉴스 → 다음 실적의 매출·이익·현금흐름 → 주가 반영 순서로 확인해야 합니다."
      ],
      "unverified": [
        "기사의 계약 금액·워런트 규모·목표주가·거래 수치는 회사 공시 또는 규제기관 원문으로 재확인해야 합니다."
      ],
    ...
    },
    {
      ...
      "aiInference": [
        "이 기사는 CRM의 사업과 관련된 'Salesforce Falls 1.4% as AIforce Faces a $46 Billion Conversion Test' 이슈입니다. 기사에 나온 전망은 아직 회사가 공시한 실적이 아니므로, 뉴스 → 다음 실적의 매출·이익·현금흐름 → 주가 반영 순서로 확인해야 합니다."
      ],
      "unverified": [
        "기사의 계약 금액·워런트 규모·목표주가·거래 수치는 회사 공시 또는 규제기관 원문으로 재확인해야 합니다."
      ],
  ...
  "byTicker": {
    "ORCL": [
      ...
      "3bab1014129eb035be51",
      "f573290cd12f0f594035",
      "ba7d40219ea0b4a5d643",
      "a1fe6cae137a1f0a09cb",
      "a91dfe4340a66db9b99f",
      "18e8091a8c737ecd4ae8",
      "45feba2e41b34ac3b288",
      "9e82a76ae643e4eb05ec",
      "a48a5cf71485b1b31b15",
      "0173afcdec962f394987",
      "fc6802acb9e740e8e2af",
      "7dc1d5513e90ad3f3ec2",
    ...
    "NVDA": [
      ...
      "bfb2a63bcb9db2cedcc0",
      "c25f8099a917f038512e",
      "833b4ff6cdfd1b9f9709",
      "e1ffb7e31839a9676eee",
      "a505722a0a93321e153d",
      "a91dfe4340a66db9b99f",
      "18e8091a8c737ecd4ae8",
      "b5dd33925d9696e0b2ed",
      "45feba2e41b34ac3b288",
      "ed5333705b669a584b33",
      "9e82a76ae643e4eb05ec",
      "a48a5cf71485b1b31b15",
      "0173afcdec962f394987",
      "8f4ab01e6e645d3edcc8",
      "fc6802acb9e740e8e2af",
      "7dc1d5513e90ad3f3ec2",
      "32115507146964400d88",
      "95eef6e689c6fec25cdb",
    ...
    "AMAT": [
      ...
      "57838e7a60395e446c39",
      "955ac7163c9cde1ca791",
      "36ae0c1c93b529267963"
    ],
    "SPY": [
      "4d3997cfb9d7cf4b4848",
      ...
      "03241d2fee23a090bd97",
      "8b13e952fa127be9ae8d",
      "b155eb38532266ea8e0a",
      "db9eda9c8855e1452a06",
      "6bb3c921cb45f4cec1fb",
      "57838e7a60395e446c39",
      "3bab1014129eb035be51",
      "f573290cd12f0f594035",
      "1719b65528d08497ad29",
      "ba7d40219ea0b4a5d643",
      "8b40f746dcd5626c66c3",
      "40e76575e9efe21f04b8",
      "4b190960341276c9144a",
      "3bfd4701f86d88ca6a98",
      "ab20c9024f5b7716eeb1",
      "9af258d7881a6d27e458",
      "66a3c3cabdeb15390d18",
      "ed5333705b669a584b33",
      "a10d59ac551b320a7074",
      "be35486f0ef2f0039df3",
      "70f1fdde695f79a680ba",
      "8f15eda6f6581558335f",
      "bd0225d4293cdf1e6316",
      "3091a0c66ecee58e87f4",
      "e68f9fcc97e1d1a9b0bb",
      "36ae0c1c93b529267963",
      "b4be506878b12d1a323f",
      "9277795a9b51a3052c11"
    ],
    "AMD": [
      "c6c690091abead480d2f",
      "8646511106f63114bd02",
    ...
    "AMZN": [
      ...
      "9cbc40498100bb4673e8",
      "833b4ff6cdfd1b9f9709",
      "a3d247944dc907df99a0",
      "e6b85321c959522f9f01",
      "87ea2099596506a138c4",
      "d842716dcd8958632a9b",
      "6c0c0040ba981ee0e5ed",
      "70f1fdde695f79a680ba",
      "5b643ad3d6b7acccb092",
      "25ffe673ac5013a0ba8e",
      "17cb6f5e6e35b5d1a198"
    ],
    "INTC": [
      ...
      "5e19dabc79f5ef3b8eb4",
      "67b2785eb60e51222106",
      "e1ffb7e31839a9676eee",
      "52c311e4a5909bfd7fd3",
      "6eaf2420474cbaaba4d3",
      "2d488242cb18fc0a10df",
      "be35486f0ef2f0039df3"
    ],
    "TSLA": [
      "88c2c52cc1a3d27c21c0",
    ...
    "PLTR": [
      ...
      "837d13bf1b429bc6181c",
      "b155eb38532266ea8e0a",
      "a505722a0a93321e153d",
      "8d33421f1db4436d1cec",
      "ab20c9024f5b7716eeb1"
    ],
    "PWR": [
      "f0a1bfaf1712324ca3de",
    ...
    "MRVL": [
      ...
      "57838e7a60395e446c39",
      "1719b65528d08497ad29",
      "e49fd3bad1f0edfeb573",
      "a51ce86c031a63f17991"
    ],
    "KLAC": [
      "2c4acc02fa8b0bade91d",
      "14ad2c163b77e9c07fb4"
    ...
    "GOOGL": [
      ...
      "a91dfe4340a66db9b99f",
      "18e8091a8c737ecd4ae8",
      "c14e0eb9803ca11f279f",
      "be35486f0ef2f0039df3",
      "fc6802acb9e740e8e2af",
      "61feb33639c19d0cfba4"
    ],
    "AAPL": [
      "c52c25fd78c11c53f34a",
      "5435830767c71e842f0f",
    ...
    "MSFT": [
      ...
      "c25f8099a917f038512e",
      "404bb0f11ca3b2cacc6c",
      "3a458d99848cc23badd8",
      "8b40f746dcd5626c66c3",
      "b0122c7806a539584b64"
    ],
    "ARM": [
      "209280f24d24757dee3f",
      "38e4cd3e0428f5789920",
    ...
    "LITE": [
      "e2ad263d41e60789005d",
      "5d5bd4f08b4d881ff690"
    ],
    "CRM": [
      "1304355796dc68a5e9a6",
      "d0939f464f0a17cec7db",
      "833b4ff6cdfd1b9f9709",
      "e3989a7eabf4963dae4f",
      "998001e676db763735fd",
      "9ebe095698addb44c7db",
      "dc02119a7aa8aa60ec28",
      "3bfd4701f86d88ca6a98",
      "9516fd83fd7b8483825f",
      "9e82a76ae643e4eb05ec",
      "3795044e0a112d640b8b",
      "8f15eda6f6581558335f",
      "32115507146964400d88",
      "bc4c4b16409e85b23338"
    ],
