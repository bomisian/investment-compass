...
const EVENT_DATA = {
  "schemaVersion": 1,
  "generatedAt": 1790070756.2548962,
  "events": [
    {
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "BE 주식, S&P 500 포함에 앞서 시판 전 점프: 미 육군이 Indelible-Bloom Coalition에 전력 임대를 승인 새로운 에이전트 연결 동향 뉴스 수익 모든 DIA 0.11% SPY 0.03% QQQ 0.05% 추세 BB 0.23% ONON 0.51% NVO 1.51% BB.TSX 7.08",
