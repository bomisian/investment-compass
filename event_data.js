...
const EVENT_DATA = {
  "schemaVersion": 1,
  "generatedAt": 1790394946.6447337,
  "events": [
    {
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "S&P 500, Dow, Nasdaq 미국-이란 분쟁 완화 조짐 속에 칩 제조업체의 강세, 석유 완화 — META, COST, MSFT, CRWD, SKHY 집중 AI 에이전트 동향 뉴스 수익 전체 DIA 0.94% SPY 0.54% QQQ 0.46% 추세 AERO 28.45% WYNN",
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "Micron 헤드라인 수익 달력; 자빌, 나이키도 덱에 등장"
      ],
      "marketInterpretation": [],
      "aiInference": [
        "사업·실적 연결 경로는 다음 공시에서 확인합니다."
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "대만 반도체: AI CapEx는 계속 상승하고 TSMC는 저평가된 것으로 보입니다"
      ],
      "marketInterpretation": [],
      "aiInference": [
        "사업·실적 연결 경로는 다음 공시에서 확인합니다."
