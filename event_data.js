...
const EVENT_DATA = {
  "schemaVersion": 1,
  "generatedAt": 1789862820.7675498,
  "events": [
    {
      ...
      "source": {
        ...
        "collectedAt": 1789862402.3810415
      },
      "confirmedFacts": [],
      "reportedClaims": [
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "AAPL 및 TSLA 영구 선물을 위한 코인베이스 파일: 신규 보고서 에이전트 연결 트렌드 뉴스 수익 모든 DIA 0.25% SPY 0.13% QQQ 0.63% 트렌드 AVAX 22.96% CVNA 1.11% XYO 1.36% ALGO 7.14% ET 0.43% AGEN 8.11% NEAR 4.65% AERO 3.05%SBUX0",
        "AAPL 및 TSLA 계약을 포함한 미국 단일 주식 영구 선물을 상장하기 위해 CFTC에 코인베이스 파일 제출 코인베이스의 서류는 Apple 계약을 모델로 사용했습니다. 이 계약은 현금 결제되고 고정 만료가 없으며 일요일부터 금요일까지 거래됩니다.",
        "2026년 2월 11일 벨기에 브뤼셀의 이 사진 그림에서 Coinbase 앱은 배경에 회사 브랜드 아이콘이 보이는 휴대폰에 표시됩니다."
      ],
      "marketInterpretation": [
        "규제와 수출 제한은 매출 시장·제품 출하·비용을 동시에 바꿀 수 있어 공식 문서의 적용 범위를 확인해야 합니다.",
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "AAPL 및 TSLA 계약을 포함한 미국 단일 주식 무기한 선물을 상장하기 위해 CFTC와 코인베이스 파일 제출"
      ],
      "marketInterpretation": [],
      "aiInference": [
    ...
    },
    {
      ...
      "reportedClaims": [
        "AI 데이터센터·반도체·전력·에너지저장 등으로 자금 공급 범위가 넓어지는 내용입니다.",
        "기사에서 언급된 규모: 0.26%, 90%, 2.43%, 18.7%, 0.63%, $336.13, $0.87, $493.78.",
        "대출·투자은행·자본시장 조달 등 여러 방식의 자금 공급이 포함될 수 있습니다."
      ],
      "marketInterpretation": [
        "AI 투자가 빅테크 자체 자금뿐 아니라 금융기관·채권시장까지 동원하는 단계로 확장됐다는 의미입니다.",
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "최고 분석가는 수익보다 터무니없는 인텔 주식 목표를 설정합니다."
      ],
      "marketInterpretation": [],
      "aiInference": [
        "사업·실적 연결 경로는 다음 공시에서 확인합니다."
    ...
    },
    {
      ...
      "impactProbability": "보통",
      "verificationStatus": "needs_confirmation",
      "headline": "US Stock Market This Week: Are SPY, QQQ Beating Asian Equities?",
      "headlineKo": "이번 주 미국 주식 시장: SPY, QQQ가 아시아 주식을 앞지르고 있습니까?",
      "source": {
        "name": "Yahoo",
        "url": "https://finnhub.io/api/news?id=b63092d3e14c6424d8d1aa8294591df3c15089e63e1b7336dc5991e15928daaa",
        "publishedAt": 1789717011,
        "collectedAt": 1789862402.3810415
      },
      "confirmedFacts": [],
      "reportedClaims": [
        "이번 주 미국 주식 시장: SPY, QQQ가 아시아 주식을 앞지르고 있습니까?",
        "신규 에이전트 연결 트렌드 뉴스 수입 전체 DIA 0.25% SPY 0.13% QQQ 0.63% Trending AVAX 22.96% CVNA 1.11% XYO 1.36% ALGO 7.14% ET 0.43% AGEN 8.11% NEAR 4.65% AERO 3.05% SBUX 0.87% FLY 3.45% 홈 뉴스 시장 주식 미국 주식 시장 Thi",
        "이번 주 미국 주식 시장: SPY, QQQ가 아시아 주식을 앞지르고 있습니까?"
      ],
      "marketInterpretation": [
        "장기 계약은 매출 가시성을 높일 수 있지만 최소구매 의무·취소 조건·실제 인식 시점이 확인돼야 합니다.",
    ...
    },
    {
      ...
      "source": {
        ...
        "collectedAt": 1789844402.0330243
      },
      "confirmedFacts": [
    ...
    },
    {
      ...
      "reportedClaims": [
        ...
        "CFO가 유지한다고 말하는 이유는 다음과 같습니다 | TIKR.com 주식 리뷰 Seagate의 총 이익은 지난 분기에 52.7%를 기록했습니다.",
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "Lumentum 주식은 이번 주에 거의 10% 상승했습니다.",
        "연간 수익률 27.5%에 대한 사례는 다음과 같습니다. TIKR.com 주식 리뷰 Lumentum 주식은 이번 주에 거의 10% 상승했습니다.",
        "연간 수익률 27.5%에 대한 사례는 다음과 같습니다. Rexielyn Diaz • 6분 읽기 검토자: David Hanson 최종 업데이트: 2026년 9월 16일 Getty Images의 Avalon_Studio Signature 및 Tiero via Canva LITE Stock에 대한 주요 통계 지난 주 실적: +9.6% 5"
      ],
      "marketInterpretation": [
        "목표주가 변경은 애널리스트의 EPS·PER 가정 변화이며 회사 공식 전망과는 구분해야 합니다.",
    ...
    },
    {
      ...
      "source": {
        ...
        "publishedAt": 1789578672,
        "collectedAt": 1789862402.3810415
      },
      "confirmedFacts": [],
      "reportedClaims": [
        "Jim Cramer calls Salesforce stock too cheap at Dreamforce 2026 Markets Jim Cramer says Salesforce stock is way too cheap as Dreamforce rolls on The CNBC host praised the enterprise software company's debt-fueled buyback and said AI disrupti",
        "At a valuation of approximately 15 times forward earnings, Cramer declared Salesforce stock is \"way too cheap\" at the CNBC Investing Club's morning meeting.",
        "He expressed confidence that Salesforce has left behind the concerns about AI disruption that had previously pressured its share price."
      ],
      "marketInterpretation": [
        "AI CAPEX 변화는 반도체·클라우드 수요와 투자 기업의 현금흐름을 서로 다른 방향으로 바꿀 수 있습니다.",
        "이번 기사에서 확인된 구체적 수치: 15 times, 2%, $45 billion — 공식 실적·가이던스와 일치하는지 확인이 필요합니다.",
        "CRM의 다음 공시에서 기사 내용이 실제 숫자로 연결되는지 확인합니다."
      ],
      "aiInference": [
        "CRM에 대한 AI 투자 변화 · 수요와 현금 부담 뉴스입니다. 현재 확인된 기사 내용이 매출·EPS·영업이익률에 어떤 영향을 주는지 다음 공시와 비교합니다."
    ...
    },
    {
      ...
      "aiInference": [
        "이 기사는 AVGO의 사업과 관련된 'Hock Tan Just Guided Broadcom's AI Revenue to Reach $230 Billion by 2028. Should You Believe Him?' 이슈입니다. 기사에 나온 전망은 아직 회사가 공시한 실적이 아니므로, 뉴스 → 매출·EPS·영업이익률 → 주가 반영 순서로 확인해야 합니다."
      ],
      "unverified": [
        "기사의 계약 금액·워런트 규모·목표주가·거래 수치는 회사 공시 또는 규제기관 원문으로 재확인해야 합니다."
      ],
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "GEV Stock Gains After CEO Signals ‘Durable Demand’, Says 2030-2040 Could Be An ‘Even Better Decade’ New Connect your Agent Trending News Earnings All DIA 1.17% SPY 0.44% QQQ 0.07% Trending SPY 0.44% QQQ 0.07% BA 3.67% FLNC 18.17% LEN 5.40% ",
        "GEV Stock Gains After CEO Signals ‘Durable Demand’, Says 2030-2040 Could Be An ‘Even Better Decade’ At the Morgan Stanley Laguna Conference, GE Vernova CEO Scott Strazik said the company could reach its $200 billion backlog milestone “very ",
        "CEO of GE Vernova Scott Strazik speaks at the Semafor World Economy 2026 summit on April 15, 2026 in Washington, DC."
      ],
      "marketInterpretation": [
        "계약 발표는 향후 매출 가시성을 높일 수 있지만 계약 금액·기간·매출 인식 시점이 확인돼야 합니다.",
        "이번 기사에서 확인된 구체적 수치: 1.17%, 0.44%, 0.07% — 공식 실적·가이던스와 일치하는지 확인이 필요합니다.",
        "GEV의 다음 공시에서 기사 내용이 실제 숫자로 연결되는지 확인합니다."
      ],
      "aiInference": [
        "GEV에 대한 고객 계약 · 매출 연결 확인 뉴스입니다. 현재 확인된 기사 내용이 매출·EPS·영업이익률에 어떤 영향을 주는지 다음 공시와 비교합니다."
      ],
      "unverified": [
        "기사의 계약 금액·워런트 규모·목표주가·거래 수치는 회사 공시 또는 규제기관 원문으로 재확인해야 합니다."
      ],
  ...
  "byTicker": {
    "SPY": [
      ...
      "1634484f6041b65ec185",
      "fbcdaa48aa358a89a1cd",
      "7cd61f5b1be9841a59f5"
    ],
    "TSLA": [
      "88c2c52cc1a3d27c21c0",
      "c52c25fd78c11c53f34a",
