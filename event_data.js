...
const EVENT_DATA = {
  "schemaVersion": 1,
  "generatedAt": 1789022968.0497715,
  "events": [
    {
    ...
    },
    {
      ...
      "reportedClaims": [
        ...
        "2026년 9월 9일 · Trefis Team MRVL YTD +165.6% SPY YTD +12.6% QQQ YTD +17.1% MRVL 분석 → MRVL(Marvell Technology) 또는 NVIDIA를 소유하고 있다면 한 가지 아이디어가 있습니다. 세상은 공급망이 허용하는 한 빨리 AI 데이터 센터를 구축하고 있습니다."
      ],
      "marketInterpretation": [
        "가이던스 변화는 다음 분기의 매출·EPS 컨센서스와 적정가 계산을 직접 바꿀 수 있습니다.",
        "이번 기사에서 확인된 구체적 수치: 165.6%, 12.6%, 17.1% — 공식 실적·가이던스와 일치하는지 확인이 필요합니다.",
        "NVDA의 다음 공시에서 기사 내용이 실제 숫자로 연결되는지 확인합니다."
      ],
      "aiInference": [
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "마이크론 영업이익률 사상 처음 80% 돌파.",
        "역사는 이것이 다음에 일어날 일이라고 말합니다.",
        "| Motley Fool 접근성 도움말 회사 소개 ▲ S&P 500 + ---% | ▲ Stock Advisor + ---% Join The Motley Fool Micron( MU +2.75% )은 메모리 칩 분야의 3대 선두 기업 중 하나입니다."
      ],
      "marketInterpretation": [
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "SanDisk는 더 희귀한 제품을 최고 가격으로 거래했습니다 | Trefis SanDisk는 더 희귀한 제품을 위해 최고 가격을 거래했습니다. 2026년 9월 9일 · by Trefis Team SNDK YTD +632.2% SPY YTD +12.6% QQQ YTD +17.1% SNDK 분석 → SanDisk(SNDK) 주가 변경",
    ...
    },
    {
      ...
      "reportedClaims": [
        ...
        "기사 본문에서 언급된 수치: $101,, 0.46%, 0.31%, 0.35%, 0.24%, 5.53%, 5.61%, 1.76%.",
      ...
      "aiInference": [
        "이 기사는 SPY의 사업과 관련된 'S&P 500, Dow, Nasdaq End Lower As Oil Crosses $101, Yields Pop Following Bessent’s Expanded Buyback Plan — AAPL, META, AMZN, CRM In Focus' 이슈입니다. 기사에 나온 전망은 아직 회사가 공시한 실적이 아니므로, 뉴스 → 매출·EPS·영업이익률 → 주가 반영 순서로 확인해야 합니다."
      ],
      "unverified": [
        "기사의 계약 금액·워런트 규모·목표주가·거래 수치는 회사 공시 또는 규제기관 원문으로 재확인해야 합니다."
      ],
    ...
    },
    {
      ...
      "reportedClaims": [
        ...
        "일일 범위 $ 638.56 - $ 657.86 52주 범위 $ 520.26 - $ 790.80 거래량 35.9M 평균 거래량 17.8M 총이익 81.75% 배당수익률 0.34% 소셜 미디어 및 디지털 광고 거대 기업인 Meta Platforms( META +6.55% ) , $653.69로 마감, 상승 W의 경우 6.55%"
      ],
      "marketInterpretation": [
    ...
    },
    {
      ...
      "reportedClaims": [
        "AI 데이터센터·반도체·전력·에너지저장 등으로 자금 공급 범위가 넓어지는 내용입니다.",
        "기사에서 언급된 규모: 0.56%, 0.41%, 0.42%, 0.34%, 9.72%, 2.36%, 2.34%, 3.58%.",
        "대출·투자은행·자본시장 조달 등 여러 방식의 자금 공급이 포함될 수 있습니다."
      ],
      "marketInterpretation": [
        "AI 투자가 빅테크 자체 자금뿐 아니라 금융기관·채권시장까지 동원하는 단계로 확장됐다는 의미입니다.",
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "Broadcom(AVGO) 2026년 3분기 실적 통화 기록 | Motley Fool 접근성 도움말 회사 소개 ▲ S&P 500 + ---% | ▲ Stock Advisor + ---% Join The Motley Fool 이미지 출처: The Motley Fool.",
        "ET CALL 참가자 투자자 관계 책임자 - Ji Ji 사장 겸 CEO - Hock Tan 최고 재무 책임자 - Amie Thuener 반도체 솔루션 그룹 사장 - Charlie Kawwas 시사점 연결 수익 - 29달러",
        "비GAAP 영업 이익 -- 상당한 영업 레버리지로 인해 전년 대비 92% 성장한 201억 달러."
      ],
      "marketInterpretation": [
        "가이던스 변화는 다음 분기의 매출·EPS 컨센서스와 적정가 계산을 직접 바꿀 수 있습니다.",
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "다음은 실적 후 오라클 주식이 얼마나 움직일 것으로 예상되는지입니다 주요 뉴스 유가 상승으로 주식 하락 ETF 출시 2026년에도 계속되는 끔찍한 속도 평균 밀레니얼 세대가 백만장자를 은퇴할 수 있습니까?",
        "30세 미만 미국인 중 거의 절반이 부모와 함께 살고 있습니다. 오라클 주식 가치는 지난 9월 사상 최고치에 비해 절반 이상 하락했습니다.",
        "Jakub Porzycki / NurPhoto / Getty Images 닫기 주요 시사점 오라클은 목요일 오후에 수익을 보고할 예정이며 옵션 가격 책정을 통해 트레이더들은 주가가 주말까지 11%까지 상승할 것으로 예상하고 있습니다."
      ],
      "marketInterpretation": [
        "목표주가 변경은 애널리스트의 EPS·PER 가정 변화이며 회사 공식 전망과는 구분해야 합니다.",
        "이번 기사에서 확인된 구체적 수치: 11%, $179,, $145. — 공식 실적·가이던스와 일치하는지 확인이 필요합니다.",
        "ORCL의 다음 공시에서 기사 내용이 실제 숫자로 연결되는지 확인합니다."
      ],
      "aiInference": [
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "Microsoft Stock이 계속해서 이렇게 수익을 낼 수 있을까요?",
        "| Trefis Microsoft 주식이 이렇게 계속 수익을 낼 수 있을까요?",
        "2026년 9월 9일 · Trefis 팀 MSFT YTD +2.8% SPY YTD +12.6% QQQ YTD +17.1% MSFT 분석 → Microsoft(MSFT)는 수년 만에 가장 수익성이 높은 구간을 벗어났으며 주식은 52주 최고치의 약 92%인 $493.95에 거래됩니다."
      ],
      "marketInterpretation": [
        "장기 계약은 매출 가시성을 높일 수 있지만 최소구매 의무·취소 조건·실제 인식 시점이 확인돼야 합니다.",
        "이번 기사에서 확인된 구체적 수치: 2.8%, 12.6%, 17.1% — 공식 실적·가이던스와 일치하는지 확인이 필요합니다.",
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "투자자가 Broadcom, Credo 및 Snowflake 수익에 대해 이해해야 할 사항"
      ],
      "marketInterpretation": [],
      "aiInference": [
        "사업·실적 연결 경로는 다음 공시에서 확인합니다."
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "Cramer는 Qualcomm의 Amazon 협력이 정체된 재고에 \"특별한 것\"을 제공한다고 말합니다."
      ],
      "marketInterpretation": [],
      "aiInference": [
        "사업·실적 연결 경로는 다음 공시에서 확인합니다."
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "Arista 대 IBM: 투자자는 지금 어떤 클라우드 AI 주식을 구매해야 할까요?"
      ],
      "marketInterpretation": [],
      "aiInference": [
        "사업·실적 연결 경로는 다음 공시에서 확인합니다."
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "광자 양자 칩의 광 손실 문제를 해결하기 위해 ASML 거래에서 XNDU 주식 상승"
      ],
      "marketInterpretation": [],
      "aiInference": [
        "사업·실적 연결 경로는 다음 공시에서 확인합니다."
    ...
    },
    {
      ...
      "reportedClaims": [
        ...
        "| Motley Fool 접근성 도움말 회사 소개 ▲ S&P 500 + ---% | ▲ Stock Advisor + ---% Join The Motley Fool 인프라 수요가 전 세계적으로 급증함에 따라 Eaton(ETN -1.64%)과 Vertiv(VRT -9.61%) 중에서 선택하려면 저울질이 필요합니다.",
    ...
    },
    {
      ...
      "source": {
        ...
        "collectedAt": 1789002352.2517457
      },
      "confirmedFacts": [
