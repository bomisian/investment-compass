...
const EVENT_DATA = {
  ...
  "events": [
    {
      ...
      "source": {
        ...
        "collectedAt": 1789747202.7968452
      },
      "confirmedFacts": [],
      "reportedClaims": [
    ...
    },
    {
      ...
      "reportedClaims": [
        "메모리 공급 부족과 가격 급등이 iPhone 18 제조원가를 높일 수 있다는 내용입니다.",
        "기사 본문에서 언급된 수치: 0.50%, 0.25%, 0.10%, 1.59%, 5.18%, 4.86%, 10.50%, 4.68%.",
        "애플의 공식 판매가·출하량 확정치가 아니라 외부 전망과 업계 추정이 섞인 뉴스입니다."
      ],
      "marketInterpretation": [
        "메모리 가격 상승이 반도체 업체 실적을 넘어 완제품 가격으로 전가되는지 확인하는 신호입니다.",
    ...
    },
    {
      ...
      "source": {
        "name": "Benzinga",
        "url": "https://finnhub.io/api/news?id=8c89a280fed23f33a0288d9baa23f4d9c873c9ee9adde5293334472472907400",
        "publishedAt": 1789724606,
        "collectedAt": 1789747202.7968452
      },
      "confirmedFacts": [],
      "reportedClaims": [
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "GNRC 주식은 5월 이후 최고의 주를 기록했습니다: Amazon 거래가 새로운 데이터 센터 성장 베팅을 촉발하고 분석가들은 Generac이 저렴하게 거래되고 있다고 말합니다. 새로운 에이전트 연결 동향 뉴스 수입 모든 DIA 0.49% SPY 0.23% QQQ 0.09% 추세 RARE 2.21% BTC 5.22%",
      ...
      "marketInterpretation": [
        "신주·워런트는 회사 자금을 늘리지만 기존 주주의 지분과 주당 이익을 희석할 수 있습니다.",
        "이번 기사에서 확인된 구체적 수치: 0.49%, 0.23%, 0.09% — 공식 실적·가이던스와 일치하는지 확인이 필요합니다.",
        "AMZN의 다음 공시에서 기사 내용이 실제 숫자로 연결되는지 확인합니다."
      ],
      "aiInference": [
    ...
    },
    {
      ...
      "reportedClaims": [
        "메모리 공급 부족과 가격 급등이 iPhone 18 제조원가를 높일 수 있다는 내용입니다.",
        "기사 본문에서 언급된 수치: 0.49%, 0.22%, 0.07%, 2.21%, 5.22%, 4.80%, 10.62%, 4.78%.",
        "애플의 공식 판매가·출하량 확정치가 아니라 외부 전망과 업계 추정이 섞인 뉴스입니다."
      ],
      "marketInterpretation": [
        "메모리 가격 상승이 반도체 업체 실적을 넘어 완제품 가격으로 전가되는지 확인하는 신호입니다.",
    ...
    },
    {
      ...
      "reportedClaims": [
        ...
        "신규 에이전트 연결 트렌드 뉴스 수입 전체 DIA 0.49% SPY 0.22% QQQ 0.08% Trending RARE 2.21% BTC 5.22% NFLX 4.80% COIN 10.74% ENPH 4.78% SNDK 6.57% SOL 9.56% APP 2.32% INTC 1.72% ROOT 3.50% 홈 뉴스 시장 주식 미국 주식 시장 Th",
        "이번 주 미국 주식 시장: SPY, QQQ가 아시아 주식을 앞지르고 있습니까?"
      ],
      "marketInterpretation": [
        "AI CAPEX 변화는 반도체·클라우드 수요와 투자 기업의 현금흐름을 서로 다른 방향으로 바꿀 수 있습니다.",
        "이번 기사에서 확인된 구체적 수치: 0.49%, 0.22%, 0.08% — 공식 실적·가이던스와 일치하는지 확인이 필요합니다.",
    ...
    },
    {
      ...
      "marketInterpretation": [
        "AI CAPEX 변화는 반도체·클라우드 수요와 투자 기업의 현금흐름을 서로 다른 방향으로 바꿀 수 있습니다.",
        "이번 기사에서 확인된 구체적 수치: $100, 0.04%, 543% — 공식 실적·가이던스와 일치하는지 확인이 필요합니다.",
        "QQQ의 다음 공시에서 기사 내용이 실제 숫자로 연결되는지 확인합니다."
      ],
      "aiInference": [
        "QQQ에 대한 AI 투자 변화 · 수요와 현금 부담 뉴스입니다. 현재 확인된 기사 내용이 매출·EPS·영업이익률에 어떤 영향을 주는지 다음 공시와 비교합니다."
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "Palantir Technologies(PLTR) AI 거래 러시, 공정 가치 논쟁에 부딪히다"
      ],
      "marketInterpretation": [],
      "aiInference": [
        "사업·실적 연결 경로는 다음 공시에서 확인합니다."
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "다음 주 Trump-Xi 만찬에 AI 타이탄이 등장합니다 - OpenAI, NVDA 및 QCOM CEO가 참석할 것이라고 보고서에 새 에이전트 연결 트렌드 뉴스 수익 모든 DIA 0.50% SPY 0.25% QQQ 0.10% Trending RARE 1.59% BTC 5.18% NFLX 4.86% COIN 10.57",
      ...
      "marketInterpretation": [
        "AI CAPEX 변화는 반도체·클라우드 수요와 투자 기업의 현금흐름을 서로 다른 방향으로 바꿀 수 있습니다.",
        "이번 기사에서 확인된 구체적 수치: 0.50%, 0.25%, 0.10% — 공식 실적·가이던스와 일치하는지 확인이 필요합니다.",
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "메모리 부족은 아직 끝나지 않았습니다: Micron과 Sandisk의 상승 여력은 더 커질까요?"
      ],
      "marketInterpretation": [],
      "aiInference": [
        "사업·실적 연결 경로는 다음 공시에서 확인합니다."
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "Arm CEO 르네 하스(Rene Haas)는 20억 달러 규모의 AI 칩 매출 목표에 대해 더 확신을 갖고 있습니다."
      ],
      "marketInterpretation": [],
      "aiInference": [
        "사업·실적 연결 경로는 다음 공시에서 확인합니다."
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "GlobalFoundries와 Marvell은 AI 데이터 센터를 위한 SiGe 거래를 확대합니다."
      ],
      "marketInterpretation": [],
      "aiInference": [
        "사업·실적 연결 경로는 다음 공시에서 확인합니다."
    ...
    },
    {
      ...
      "source": {
        ...
        "publishedAt": 1789545663,
        "collectedAt": 1789747202.7968452
      },
      "confirmedFacts": [],
      "reportedClaims": [
        "Quanta Services (NYSE:PWR) Clears Eight-Rule Growth Screen With Accelerating Earnings and Sales",
        "제목만으로는 수치와 원인을 확정할 수 없습니다."
      ],
      "marketInterpretation": [
        "매출·영업이익·현금흐름과 순이익 특이항목을 분리해야 다음 실적의 반복 가능성을 판단할 수 있습니다.",
    ...
    },
    {
      ...
      "impactProbability": "낮음·확인 필요",
      "verificationStatus": "needs_confirmation",
      "headline": "Taiwan Semiconductor Executive Calls AI Toddler With Superpowers",
      "headlineKo": "대만 반도체 경영진, AI 유아에게 초능력을 요청",
      "source": {
        "name": "Benzinga",
        "url": "https://finnhub.io/api/news?id=30d1d6a3f67fc04bc2e4442d6024d0c8ff077e37cc39961ffb0f94c8adecd202",
        "publishedAt": 1789542837,
        "collectedAt": 1789747202.7968452
      },
      "confirmedFacts": [],
      "reportedClaims": [
        "Taiwan Semiconductor Executive Calls AI Toddler With Superpowers",
        "제목만으로는 수치와 원인을 확정할 수 없습니다."
      ],
      "marketInterpretation": [
        "AI CAPEX 변화는 반도체·클라우드 수요와 투자 기업의 현금흐름을 서로 다른 방향으로 바꿀 수 있습니다.",
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "ORCL 주식이 5회 연속 하락: Traders Eye OpenAI 자금 조달 뉴스, 촉매제로서의 일본 클라우드 거래 가능성"
      ],
      "marketInterpretation": [],
      "aiInference": [
        "사업·실적 연결 경로는 다음 공시에서 확인합니다."
    ...
    },
    {
      ...
      "aiInference": [
        "이 기사는 NVDA의 사업과 관련된 'Michael Burry Just Said 7 Words Dismissing AI After Slowdown Fears: \"There Is Nothing AI to Slow Down.\" Should Investors Trust His Nvidia and Palantir Shorts?' 이슈입니다. 기사에 나온 전망은 아직 회사가 공시한 실적이 아니므로, 뉴스 → 매출·EPS·영업이익률 → 주가 반영 순서로 확인해야 합니다."
      ],
      "unverified": [
        "기사의 계약 금액·워런트 규모·목표주가·거래 수치는 회사 공시 또는 규제기관 원문으로 재확인해야 합니다."
      ],
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "QCOM Stock Climbs To 2-Month High As AI Data Center Push Gains Momentum New Connect your Agent Trending News Earnings All DIA 1.17% SPY 0.45% QQQ 0.07% Trending SPY 0.45% QQQ 0.07% BA 3.68% FLNC 20.43% RCAT 10.23% GME 2.61% LEN 4.83% IWM 0.",
        "QCOM Stock Climbs To 2-Month High As AI Data Center Push Gains Momentum Qualcomm’s diversification beyond smartphones is gaining traction as investors assess its potential role in hyperscaler AI infrastructure.",
    ...
    },
    {
      ...
      "source": {
        ...
        "publishedAt": 1789526236,
        "collectedAt": 1789747202.7968452
      },
      "confirmedFacts": [],
      "reportedClaims": [
        "Should You Get Paid While Eaton Finishes Its Factories?",
        "| Trefis Should You Get Paid While Eaton Finishes Its Factories?",
        "September 15th, 2026 · by Trefis Team ETN YTD +24.2% SPY YTD +11.4% XLI YTD +9.2% Analyze ETN → Eaton (ETN) trades about 15% below its 52-week high and has gained less than the S&P 500 over the past year."
      ],
      "marketInterpretation": [
        "AI CAPEX 변화는 반도체·클라우드 수요와 투자 기업의 현금흐름을 서로 다른 방향으로 바꿀 수 있습니다.",
        "이번 기사에서 확인된 구체적 수치: 8.4%, 30%, $280. — 공식 실적·가이던스와 일치하는지 확인이 필요합니다.",
        "ETN의 다음 공시에서 기사 내용이 실제 숫자로 연결되는지 확인합니다."
      ],
      "aiInference": [
        "ETN에 대한 AI 투자 변화 · 수요와 현금 부담 뉴스입니다. 현재 확인된 기사 내용이 매출·EPS·영업이익률에 어떤 영향을 주는지 다음 공시와 비교합니다."
    ...
    },
    {
      ...
      "aiInference": [
        "이 기사는 ORCL의 사업과 관련된 'Oracle (ORCL) Introduced Java 27 With Post Quantum Cryptography' 이슈입니다. 기사에 나온 전망은 아직 회사가 공시한 실적이 아니므로, 뉴스 → 다음 실적의 매출·이익·현금흐름 → 주가 반영 순서로 확인해야 합니다."
      ],
      "unverified": [
        "기사의 계약 금액·워런트 규모·목표주가·거래 수치는 회사 공시 또는 규제기관 원문으로 재확인해야 합니다.",
        "현재 캐시는 제목 또는 제한된 본문을 기반으로 하므로 세부 조건을 확정 사실로 저장하지 않습니다."
    ...
    },
    {
      ...
      "impactProbability": "보통",
      "verificationStatus": "needs_confirmation",
      "headline": "Intuitive Machines vs. Vertiv: Which Industrials Stock Is a Better Buy in 2026?",
      "headlineKo": "Intuitive Machines vs. Vertiv: 2026년에는 어떤 산업재 주식을 구매하는 것이 더 나은가요?",
      "source": {
        "name": "Yahoo",
        "url": "https://finnhub.io/api/news?id=d6c78ff6bfbbb964f4b33f062c3d432fe0189c113d4dd9daa7b1dd6919e66999",
      ...
      "reportedClaims": [
        ...
        "Intuitive Machines Inc( LUNR +6.63% )와 Vertiv Holdings LLC( VRT +0.87% ) 중에서 결정하려면 즉각적인 AI 기반 성장과 장기적인 우주 탐사를 비교해야 합니다."
      ],
      "marketInterpretation": [
        "부품 부족과 생산 지연은 출하량·재고·마진에 순차적으로 반영될 수 있습니다.",
        "이번 기사에서 확인된 구체적 수치: 6.63%, 0.87%, $ 14.79 — 공식 실적·가이던스와 일치하는지 확인이 필요합니다.",
        "VRT의 다음 공시에서 기사 내용이 실제 숫자로 연결되는지 확인합니다."
      ],
      "aiInference": [
    ...
    },
    {
      ...
      "aiInference": [
        "이 기사는 NVDA의 사업과 관련된 'Nvidia (NVDA) Is Discussing Up To $10 Billion For An AI IPO' 이슈입니다. 기사에 나온 전망은 아직 회사가 공시한 실적이 아니므로, 뉴스 → 다음 실적의 매출·이익·현금흐름 → 주가 반영 순서로 확인해야 합니다."
      ],
      "unverified": [
        "기사의 계약 금액·워런트 규모·목표주가·거래 수치는 회사 공시 또는 규제기관 원문으로 재확인해야 합니다."
      ],
    ...
    },
    {
      ...
      "source": {
        ...
        "publishedAt": 1789510085,
        "collectedAt": 1789747202.7968452
      },
      "confirmedFacts": [],
      "reportedClaims": [
        "Arista의 세 번째 가이던스 레이즈가 여전히 돈을 벌 수 있습니까?",
        "| Trefis Arista의 세 번째 가이던스 인상이 여전히 수익을 창출할 수 있나요?",
        "2026년 9월 15일 · 작성자: Trefis Team ANET YTD +47.2% SPY YTD +11.4% QQQ YTD +14.8% ANET 분석 → Arista Networks(ANET)는 188달러 근처에서 거래되고 있으며, 이는 8월 보고서에서 2026년 수익 전망을 세 번째로 높이기 전의 위치였습니다."
      ],
      "marketInterpretation": [
        "가이던스 변화는 다음 분기의 매출·EPS 컨센서스와 적정가 계산을 직접 바꿀 수 있습니다.",
        "이번 기사에서 확인된 구체적 수치: 47.2%, 11.4%, 14.8% — 공식 실적·가이던스와 일치하는지 확인이 필요합니다.",
        "ANET의 다음 공시에서 기사 내용이 실제 숫자로 연결되는지 확인합니다."
      ],
      "aiInference": [
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "S&P 500, Nasdaq, Dow는 연준 회의를 앞두고 투자자 가격이 인상되면서 하락 마감 — AMZN, META, MU, TSLA, PLTR 초점 신규 에이전트 연결 동향 뉴스 수익 전체 DIA 0.62% SPY 1.10% QQQ 1.68% 추세 DKNG 7.40% GME 3.64% RARE 15.",
    ...
    },
    {
      ...
      "impactProbability": "보통",
      "verificationStatus": "needs_confirmation",
      "headline": "NVIDIA (NVDA) Gets A Fresh Platform Test After Salesforce Deal Sparks Undervalued View",
      "headlineKo": "NVIDIA(NVDA)는 Salesforce 거래로 인해 저평가된 견해를 촉발한 후 새로운 플랫폼 테스트를 받았습니다.",
      "source": {
        "name": "Yahoo",
        "url": "https://finnhub.io/api/news?id=6a740db073e65b758284a46c3b47fbb8f82ef2de169baf77c3457fe3f490655f",
        "publishedAt": 1789506958,
        "collectedAt": 1789747202.7968452
      },
      "confirmedFacts": [],
      "reportedClaims": [
        "NVIDIA (NVDA) Gets A Fresh Platform Test After Salesforce Deal Sparks Undervalued View",
        "제목만으로는 수치와 원인을 확정할 수 없습니다."
      ],
      "marketInterpretation": [
        "계약 발표는 향후 매출 가시성을 높일 수 있지만 계약 금액·기간·매출 인식 시점이 확인돼야 합니다.",
    ...
    },
    {
      ...
      "impactProbability": "보통",
      "verificationStatus": "needs_confirmation",
      "headline": "Taiwan Semi Revenue Keeps Surging. How to Play TSM Stock in September 2026.",
      "headlineKo": "대만 세미 매출 계속 급증. 2026년 9월 TSM 주식을 플레이하는 방법.",
      "source": {
        "name": "Yahoo",
        "url": "https://finnhub.io/api/news?id=72a47bc4c6a1c88c39c631bd073d6609954e42aef7107235be3d3fdb422de2aa",
        "publishedAt": 1789506897,
        "collectedAt": 1789747202.7968452
      },
      "confirmedFacts": [],
      "reportedClaims": [
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "규제 당국이 바퀴 없는 사이버캡을 사람이 운전할 수 있는지 묻는 후 TSLA 가장자리가 낮아짐"
      ],
      "marketInterpretation": [],
      "aiInference": [
        "사업·실적 연결 경로는 다음 공시에서 확인합니다."
    ...
    },
    {
      ...
      "source": {
        ...
        "publishedAt": 1789503218,
        "collectedAt": 1789747202.7968452
      },
      "confirmedFacts": [],
      "reportedClaims": [
        "수익 급증 후 주요 수준의 Microsoft; Microsoft는 지금 구입합니까?"
      ],
      "marketInterpretation": [],
      "aiInference": [
        "사업·실적 연결 경로는 다음 공시에서 확인합니다."
  ...
  "byTicker": {
    "NVDA": [
      ...
      "08e8464ea255b351f00f",
      "73ac2cf8e14ab103cfc1",
      "18ba5e5d76041e245e20",
      "dce2b9bf2760d850ecb2",
    ...
    "QQQ": [
      ...
      "32f774ca32b9d01d172a",
      "e97402f29b3673422fa9",
      "779469a0aff5ec8c24e8",
    ...
    "SPY": [
      ...
      "e97402f29b3673422fa9",
      "73ac2cf8e14ab103cfc1",
      "a2b98223d200d74b1318",
      "9c94ea50538cbe59fe52",
      "779469a0aff5ec8c24e8",
      "651799e9871e68378cc7",
      "89904e2a7ad2e5c2c730",
      "2042ed7b9f52da1b9a52"
    ],
    "AAPL": [
    ...
    "META": [
      ...
      "00aca045952220366f55",
      "651799e9871e68378cc7",
      "18ab7fbd2f3aeb135149",
      "2afd76ff42336f63205a"
    ],
    "GOOGL": [
    ...
    "ORCL": [
      ...
      "a9cc191d7fece1ecb9c5",
      "9c997994fdcaa7c3b408",
      "d696a8688f3eb1d181c5",
      "08e8464ea255b351f00f",
      "ddfcbab5d20cf6e0584a",
      "dce2b9bf2760d850ecb2"
    ],
    "ANET": [
    ...
    "TSM": [
      ...
      "692ef92f49e0b4cb0349",
      "cb43b8aee1c751382be3",
      "1858d519ef8f5373955f",
      "445d0d6bd610a1a8c1a0"
    ],
    "AMD": [
      "66db2442882959a41298",
      "71e9832ca53f6a03f9b1",
