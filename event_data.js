...
const EVENT_DATA = {
  "schemaVersion": 1,
  "generatedAt": 1788415173.5878763,
  "events": [
    {
    ...
    },
    {
      ...
      "headlineKo": "Leopold Aschenbrenner의 AI 펀드가 강제로 매각되었습니다. Micron과 SanDisk는 틀렸는가? 아니면 단지 레버리지만 있었는가?",
      "source": {
        "name": "Yahoo",
      ...
      "aiInference": [
        "이 기사는 SNDK의 사업과 관련된 'Leopold Aschenbrenner’s AI Fund Was Forced to Sell. Were Micron and SanDisk Wrong—or Just the Leverage?' 이슈입니다. 기사에 나온 전망은 아직 회사가 공시한 실적이 아니므로, 뉴스 → 다음 실적의 매출·이익·현금흐름 → 주가 반영 순서로 확인해야 합니다."
      ],
      "unverified": [
        "기사의 계약 금액·워런트 규모·목표주가·거래 수치는 회사 공시 또는 규제기관 원문으로 재확인해야 합니다."
      ],
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "Dell은 메모리 칩 부족을 지적했습니다. 마이크론 스톡은 어깨를 으쓱합니다."
      ],
      "marketInterpretation": [],
      "aiInference": [
        "사업·실적 연결 경로는 다음 공시에서 확인합니다."
    ...
    },
    {
      ...
      "confirmedFacts": [],
      "reportedClaims": [
        "QCOM 주식: 자동차 및 AI 성장이 휴대폰 문제를 상쇄할 수 있음 주요 내용으로 건너뛰기 → 이 잘 알려지지 않은 금 펀드는 매주 금요일에 현금을 분배합니다(Investors Alley에서) (광고) Qualcomm의 AI 야망이 스마트폰에 부딪힌다 현실 점검 작성",
        "닫기 주요 사항 Qualcomm의 휴대폰 사업은 OEM 구축 계획 감소, 메모리 비용 및 Apple의 자체 모뎀 전환으로 인해 여전히 압박을 받고 있습니다.",
        "Qualcomm의 자동차 및 IoT 사업은 성장하고 있으며 경영진은 2029 회계연도 비휴대폰 매출 목표를 400억 달러로 높였습니다."
      ],
      "marketInterpretation": [
        "목표주가 변경은 애널리스트의 EPS·PER 가정 변화이며 회사 공식 전망과는 구분해야 합니다.",
