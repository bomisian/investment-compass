...
const FUNDAMENTAL_INTELLIGENCE_DATA = {
  ...
  "generatedAt": 1787724471.520135,
  "records": {
    "MSFT": {
      "ticker": "MSFT",
      "asOf": 1787724471.520135,
      "modelVersion": "fundamental-v1.3",
    ...
    "SNDK": {
      ...
      "priceSigma": 0.42,
      "priceDamage": 14.0,
      "fundamentalDamage": 31.5,
      "thesisDamage": 7.0,
      "thesisStatus": "weakening",
      "damageRead": "펀더멘털 위험 신호가 가격에 충분히 반영되지 않았을 가능성이 있습니다.",
      "dimensions": {
        "growth": {
          "score": 16.690000333333334,
          "applicable": true
        },
        "earningsQuality": {
          "score": 100,
