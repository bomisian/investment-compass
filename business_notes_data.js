...
const BUSINESS_NOTES = {
  QCOM: {
    ...
    role: {
      ...
      stars: 3,
      note: "스마트폰 SoC·모뎀의 오랜 강자지만 최대 고객 애플이 자체 모뎀으로 이탈 중이라 모바일 지배력이 약해지고 있고, 자동차·데이터센터는 아직 대체 축으로 자리잡는 과정이에요.",
    },
  },
  NVDA: {
    updated: "2026-08-10",
    ...
    role: {
      ...
      stars: 5,
      note: "AI 가속기 시장에서 사실상 독점적 지위예요. 하드웨어뿐 아니라 CUDA 소프트웨어 생태계까지 갖추고 있어서 경쟁사가 성능을 따라와도 대체하기 어려운 구조예요.",
    },
  },
  GOOGL: {
    updated: "2026-08-13",
    ...
    role: {
      ...
      stars: 4,
      note: "검색·유튜브·클라우드 세 축 모두 여전히 압도적이지만, 차세대 AI 모델(제미나이 3.5)이 반복 지연되며 AI 경쟁에서 뒤처질 수 있다는 선행 리스크가 있어요.",
    },
  },
  META: {
    updated: "2026-08-13",
    ...
    role: {
      ...
      stars: 3,
      note: "디지털 광고 시장의 최상위권 강자지만, 광고 자체는 대체 가능한 여러 플랫폼 중 하나예요. AI 하드웨어(리얼리티랩스)는 아직 대규모 손실을 내는 신사업 단계고요.",
    },
  },
  PLTR: {
    updated: "2026-08-13",
    ...
    role: {
      ...
      stars: 4,
      note: "정부(국방·정보) 분야는 진입장벽이 높아 사실상 대체하기 어려운 위치예요. 상업(민간기업) 쪽은 경쟁이 있지만 AIP로 빠르게 확장 중이고요. 다만 밸류에이션이 매우 높아 실적 대비 기대가 이미 많이 반영돼 있어요.",
    },
  },
  TSM: {
    updated: "2026-08-10",
    ...
    role: {
      ...
      stars: 5,
      note: "첨단 파운드리 시장 점유율 72%대로, 엔비디아·애플 등 거의 모든 팹리스 기업이 최선단 칩을 맡길 곳이 사실상 이 회사뿐이에요. 대체재가 없는 구조라는 점에서 ASML급으로 봐요.",
    },
  },
  ...
  MU: {
    ...
    role: {
      ...
      stars: 5,
      note: "AI 서버에 필수인 HBM을 포함해 메모리 전 영역(D램·낸드)을 다루는 소수 기업 중 하나예요. 2026년 HBM 공급이 이미 완판됐을 만큼 수요 대비 공급이 부족한 위치고요.",
    },
  },
  SNDK: {
    updated: "2026-08-13",
    ...
    role: {
      ...
      stars: 3,
      note: "낸드 한 분야에 집중된 전문기업이에요. 낸드 슈퍼사이클의 대표 수혜주지만, D램도 같이 파는 MU 대비 사이클 변동에 더 크게 노출되는 구조예요.",
    },
  },
  WDC: {
    updated: "2026-08-13",
    ...
    role: {
      ...
      stars: 4,
      note: "대용량 저장에서 HDD가 SSD보다 약 7배 저렴해 AI 시대 벌크 스토리지 수요에 최적화된 위치예요. 2026년 생산능력이 이미 매진된 상태고요.",
    },
  },
  MRVL: {
    updated: "2026-08-13",
    ...
    role: {
      ...
      stars: 3,
      note: "하이퍼스케일러向 맞춤형 AI 반도체 설계에서 브로드컴과 함께 손꼽히는 업체예요. 다만 브로드컴 대비 규모가 작고, GAAP 회계상 인수 관련 비용 부담이 구조적으로 큰 편이에요.",
    },
  },
  INTC: {
    updated: "2026-08-13",
    ...
    role: {
      ...
      stars: 2,
      note: "한때 반도체 업계를 지배했지만 지금은 파운드리 사업 턴어라운드를 진행 중인 후발주자예요. 제품(CPU) 매출은 AI 수요로 회복 중이지만 파운드리 흑자전환까지는 갈 길이 남아있어요.",
    },
  },
  ...
  ORCL: {
    ...
    role: {
      ...
      stars: 3,
      note: "기업용 데이터베이스에서는 오랜 강자지만 클라우드 인프라(OCI)는 AWS·애저·GCP 대비 후발주자예요. 대형 AI 인프라 수주(RPO $638B)는 매력적이지만 그걸 빚으로 지어내는 재무 부담이 커요.",
    },
  },
  ...
  MSFT: {
    ...
    role: {
      ...
      stars: 4,
      note: "클라우드·생산성·PC 세 사업이 균형 잡혀 있고 Azure가 하이퍼스케일러 3강 중 하나예요. 다만 클라우드는 AWS·GCP와 직접 경쟁하는 시장이라 독점적 지위는 아니에요.",
    },
  },
  AMZN: {
    updated: "2026-08-13",
    ...
    role: {
      ...
      stars: 4,
      note: "전자상거래 최대 사업자면서 클라우드(AWS)까지 장악한 독특한 조합이에요. 다만 리테일·클라우드 둘 다 경쟁자(MSFT·구글 등)가 있는 시장이라 완전한 독점은 아니에요.",
    },
  },
  AAPL: {
    updated: "2026-08-13",
    ...
    role: {
      ...
      stars: 4,
      note: "25억대 활성기기·89% 재구매율이라는 압도적 생태계 락인이 핵심 경쟁력이에요. 다만 AI 경쟁에서 1~2년 뒤처졌다는 평가가 있어 다음 제품 사이클에서의 실행력이 중요해요.",
    },
  },
  TSLA: {
    updated: "2026-08-13",
    ...
    role: {
      ...
      stars: 3,
      note: "EV 시장을 개척한 회사지만 최근 판매량은 정체·역성장 중이에요. 에너지 저장 사업이 빠르게 크고 있고, 로보택시·옵티머스는 아직 본격 매출 전 단계라 미래 가치 비중이 커요.",
    },
  },
  CRM: {
    updated: "2026-08-13",
    ...
    role: {
      ...
      stars: 3,
      note: "CRM(고객관계관리) 소프트웨어 시장의 오랜 리더지만, 마이크로소프트 Dynamics·허브스팟 등과 경쟁이 심한 분야예요. Agentforce의 실제 수익화 속도가 다음 성장의 관건이에요.",
    },
  },
  AMD: {
    updated: "2026-08-13",
    ...
    role: {
      ...
      stars: 3,
      note: "엔비디아 독주 체제에서 AI 가속기의 '실질적인 2번째 대안'으로 자리잡고 있어요. 데이터센터 매출이 빠르게 크고 있지만 여전히 엔비디아 대비 점유율은 작은 도전자 위치예요.",
    },
  },
  AVGO: {
    ...
    role: {
      ...
      stars: 4,
      note: "하이퍼스케일러들의 자체 AI 칩(TPU류) 설계를 돕는 핵심 파트너로, 이 영역에서 대체하기 쉽지 않은 위치예요. 다만 핵심 고객이 단 6곳뿐이라 고객 집중 리스크가 커요.",
    },
  },
  ARM: {
    updated: "2026-08-13",
    ...
    role: {
      ...
      stars: 4,
      note: "거의 모든 모바일 칩이 Arm 아키텍처를 쓰고 있어서 사실상 업계 표준이에요. 다만 RISC-V 같은 오픈소스 대안이 서서히 부상하고 있고, 최근 주가 변동성이 극단적으로 커요.",
    },
  },
  ASML: {
    updated: "2026-08-13",
    ...
    role: {
      ...
      stars: 5,
      note: "최첨단 반도체(5nm 이하) 생산에 필수인 EUV 장비를 사실상 독점 공급해요(점유율 90% 이상). 대체재가 거의 없는, 이 워치리스트에서 가장 확실한 '병목' 기업이에요.",
    },
  },
  AMAT: {
    updated: "2026-08-13",
    ...
    role: {
      ...
      stars: 4,
      note: "반도체 제조 공정의 여러 단계에 걸쳐 폭넓은 장비 포트폴리오를 갖춘 최대 장비업체 중 하나예요. 다만 특정 공정에서는 LRCX·KLAC 등과 직접 경쟁해요.",
    },
  },
  LRCX: {
    updated: "2026-08-13",
    ...
    role: {
      tags: ["식각(etch)·증착 장비"],
      stars: 4,
      note: "식각 장비 시장 점유율 약 55%로 이 공정에서는 지배적이에요. 다만 장비 시장 전체로 보면 AMAT와 영역이 겹치는 부분도 있어요.",
    },
  },
  KLAC: {
    updated: "2026-08-13",
    ...
    role: {
      tags: ["검사·계측 장비(공정관리)"],
      stars: 4,
      note: "반도체가 복잡해질수록 defect(결함) 관리가 중요해지는데, 이 분야 점유율이 약 60%로 2위 업체보다 7배 규모예요. 다만 매출의 30%가 중국이라 수출규제에 민감해요.",
    },
  },
  ANET: {
    updated: "2026-08-19",
    role: {
      ...
      stars: 4,
      note: "하이퍼스케일러 데이터센터 네트워킹 장비 시장의 선두주자예요. 시스코 등과 경쟁은 있지만, 대형 AI 클러스터의 고성능 네트워킹에서는 검증된 강자로 꼽혀요.",
    },
  },
  COHR: {
    updated: "2026-08-19",
    role: {
      ...
      stars: 3,
      note: "AI 데이터센터 간 대용량 데이터 전송에 필요한 광통신 부품을 만들어요. 다만 이 분야엔 Lumentum 등 경쟁사가 있어 독점적 지위는 아니에요.",
    },
  },
  LITE: {
    updated: "2026-08-19",
    role: {
      tags: ["광통신 부품(레이저·옵틱스)"],
      stars: 3,
      note: "COHR와 비슷한 포지션의 광통신 부품업체예요. AI 데이터센터 인터커넥트 수요의 수혜주지만 경쟁 구도라 대체 가능성이 있어요.",
    },
  },
  GEV: {
    updated: "2026-08-19",
    role: {
      ...
      stars: 5,
      note: "AI 데이터센터 급증으로 전력 수요가 폭발하는 가운데, 발전(가스터빈)부터 송배전까지 전력 밸류체인 전반을 아우르는 몇 안 되는 기업이에요. GE에서 분사한 회사로 가스터빈 대형 발주 잔고가 이미 수년치 쌓여있는 것으로 알려져 있어요.",
    },
  },
  CEG: {
    updated: "2026-08-19",
    role: {
      ...
      stars: 4,
      note: "미국 최대 원자력 발전사업자 중 하나로, 마이크로소프트의 스리마일아일랜드 원전 재가동 계약처럼 빅테크와 직접 전력공급계약(PPA)을 맺는 사례로 주목받고 있어요. 원자력이라는 특수 자산이 강점이지만 발전사업자 자체는 다수 존재해요.",
    },
  },
  VST: {
    updated: "2026-08-19",
    role: {
      ...
      stars: 3,
      note: "다양한 발전원을 보유한 종합 전력회사예요. CEG 대비 원자력 비중이 상대적으로 낮고 경쟁하는 발전사업자가 여럿 있어요.",
    },
  },
  ETN: {
    updated: "2026-08-19",
    role: {
      tags: ["전력관리 인프라", "변압기·배전 설비"],
      stars: 4,
      note: "데이터센터·산업시설의 전력관리 인프라를 만드는 핵심 공급사예요. 슈나이더·ABB 등과 경쟁하지만 오랜 업력과 폭넓은 제품군을 갖춘 선두권 업체예요.",
    },
  },
  PWR: {
    updated: "2026-08-19",
    role: {
      ...
      stars: 4,
      note: "전력망을 실제로 짓고 연결하는 시공 능력은 장비 제조보다 대체하기 어려운 노하우·인력 집약적 영역이에요. 미국 최대 전력 인프라 시공업체 중 하나로 꼽혀요.",
    },
  },
  HUBB: {
    updated: "2026-08-19",
    role: {
      ...
      stars: 3,
      note: "전력 배전 장비를 만드는 업체로, ETN·슈나이더 등 대형 경쟁사 대비 규모는 작지만 특정 제품군에서 입지를 갖고 있어요.",
    },
  },
  VRT: {
    updated: "2026-08-19",
    role: {
      ...
      stars: 5,
      note: "AI 데이터센터가 필수로 요구하는 전력(UPS)·냉각 인프라 전문기업으로, 엔비디아 등 AI 서버 공급망의 핵심 파트너로 자주 언급돼요. AI 데이터센터 건설 자체가 이 회사 없이는 어려운 구조라고 봐요.",
    },
  },
  MOD: {
    updated: "2026-08-19",
    role: {
      ...
      stars: 3,
      note: "열관리(냉각) 분야 참여자인데, 데이터센터 전용으로는 Vertiv 등 대형 업체 대비 상대적으로 작은 플레이어예요.",
    },
  },
  STX: {
    updated: "2026-08-19",
    role: {
      ...
      stars: 4,
      note: "WDC와 함께 AI 데이터센터向 대용량 HDD를 양분하는 업체예요(듀오폴리에 가까운 구조) - 대용량 저장 수요가 이 두 회사에 집중되는 구조라는 점에서 역할이 비슷해요.",
    },
  },
  EME: {
    updated: "2026-08-19",
    role: {
      ...
      stars: 3,
      note: "데이터센터·산업시설 전기설비를 시공하는 업체예요. 수요 자체는 확실하지만 비슷한 시공 능력을 가진 경쟁사가 여럿 있는 분야예요.",
    },
  },
  FIX: {
    updated: "2026-08-19",
    role: {
      ...
      stars: 3,
      note: "EME와 비슷하게 데이터센터·상업시설의 냉난방·기계설비를 시공하는 업체예요. 시공업이라 대체 가능한 경쟁사가 존재해요.",
    },
  },
  SBGSY: {
    updated: "2026-08-19",
    role: {
      ...
      stars: 4,
      note: "전력관리·산업자동화 분야에서 ETN과 함께 글로벌 최상위권으로 꼽히는 프랑스 기업이에요. ⚠️ 다만 미국 primary 상장이 아니라 OTC ADR(SBGSY)이라 거래량이 얇고 데이터 신뢰도가 다른 종목보다 낮을 수 있어요 - 참고용으로만 보는 걸 추천해요.",
    },
  },
};
