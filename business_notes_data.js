    ...
    newsLog: [
      {
        ...
        interpretation: "이번 실적은 매출·EPS 모두 컨센서스를 상회한 견조한 결과였으나, Q4 매출 가이던스가 시장 기대에 소폭 못 미치면서 '높은 눈높이'를 완전히 충족시키지는 못했다. AI 반도체 매출(+221%, Q4 가이던스 +236%)은 여전히 고성장 궤도를 유지하고 있어 펀더멘털 훼손으로 보기는 어렵고, 이번 하락은 8/20 마벨-구글 계약 이후 이어진 고객 다변화 우려와 결합된 밸류에이션 조정 성격에 가깝다.",
        ...
        sources: [
          ...
          { title: "Broadcom stock sinks in after-hours as AI chip forecast disappoints (Yahoo Finance)", url: "https://finance.yahoo.com/markets/article/broadcom-stock-sinks-in-after-hours-as-ai-chip-forecast-disappoints-165602504.html" },
        ],
      },
      {
        date: "2026-09-02",
