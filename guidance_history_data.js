...
const GUIDANCE_HISTORY_DATA = {
  "AMAT": [
    ...
    },
    {
      ...
      "guidance": {
        ...
        "comparison": "no_prior_guidance",
        "_targetPeriodCorrection": "2026-09-15 외부 검토로 발견 - \"Applied is total revenue ... for the fourth quarter of fiscal 2026 are expected to be...\" 문장에서 서수(fourth)가 marker(\"expected\")로부터 30자 넘게 떨어져 있어 잘려나갔고, 그 결과 이 실적 발표 자체의 분기 제목(3분기)이 다음 가이던스 대상기간으로 잘못 채택됐었다. 코드의 before-윈도우를 넓혀 수정함."
      },
      "comparison": {
        "status": "unavailable",
        "reason": "같은 대상기간의 이전 공식 가이던스 없음"
  ...
  "MRVL": [
        ...
        "metrics": [
          {
            ...
            "unit": "billion",
            "deltaUnit": "percent",
            "_deltaUnitCorrection": "2026-09-15 외부 검토로 발견 - MRVL 8-K는 매출 가이던스를 항상 금액이 아니라 비율(+/- X%)로 제시하는데, 예전 파싱 코드가 \"%\" 뒤 \\b 경계 처리 버그로 percent를 못 알아채고 매번 center와 같은 단위(billion)로 잘못 저장했다(실측: 2026-08-27 공시 원문 재확인 결과 \"+/- 5%\"이고 대상분기는 FY2027 Q3). 코드는 고쳤고(percent 인식·계산 수정), 이 기록들은 같은 반복 패턴이라 일괄 보정한다."
          }
        ],
        "targetPeriod": null,
        "comparison": "no_prior_guidance"
    ...
    },
    {
      ...
      "guidance": {
        ...
        "comparison": "no_prior_guidance",
        "_targetPeriodCorrection": "2026-09-15 외부 검토로 발견 - 직전 분기 실적 회고 문장(\"...guidance provided on May 27, 2026\")이 새 가이던스 대상기간으로 잘못 채택됐었다(원래 second quarter 2027로 저장). SEC 원문 재확인 결과 이 가이던스 섹션 제목은 \"Third Quarter of Fiscal 2027 Financial Outlook\"이다. 코드도 회고 문장을 배제하도록 수정함."
      },
      "comparison": {
        "status": "unavailable",
        "reason": "같은 대상기간의 이전 공식 가이던스 없음"
  ...
  "ANET": [
    ...
    },
    {
      "capturedAt": 1789435214.0475078,
      "filingDate": "2026-08-04",
      "accessionNumber": "0001596532-26-000174",
  ...
  "CEG": [
    ...
    },
    {
      ...
      "accessionNumber": "0001868275-26-000097",
  ...
  "VST": [
    {
      ...
      "quarantined": true,
      "quarantineReason": "2026-09-15 검증: 원문은 '2024년 조정 EBITDA에 세액공제가 약 $500M 기여할 수 있다'는 서술인데 매출 가이던스로 잘못 파싱되어 low=500/high=2024(연도 숫자)가 매출 범위로 저장됨. 대상기간도 '2024년 3분기'로 저장됐지만 결과 대조는 4분기 실적을 사용해 기간도 불일치. 현재 가이던스 카드·비교·성과판정에서 제외(격리). 원본은 감사 이력 보존을 위해 삭제하지 않음."
    }
  ],
  "PWR": [
    {
  ...
  "ETN": [
    {
      "capturedAt": 1789388953.3311799,
      "filingDate": "2026-07-31",
      "accessionNumber": "0001551182-26-000027",
      "sourceUrl": "https://www.sec.gov/Archives/edgar/data/1551182/000155118226000027/etn06302026exhibit99.htm",
      "guidance": {
        "status": "available",
        "metrics": [
          {
...
// 티커별 '가장 최근 공시를 언제·어떤 결과로 확인했는지'(성공/실패 무관). checkedAt(수집 시각),
// filingDate(그 공시 날짜), guidanceStatus(available/unavailable/unavailable_no_target_period),
// exhibitStatus(원문 수집 성공 여부).
const GUIDANCE_LAST_CHECK_DATA = {
  "MSFT": {
    "checkedAt": 1789221603.113387,
    "filingDate": "2026-07-29",
    "accessionNumber": "0001193125-26-323632",
    "guidanceStatus": "unavailable_no_target_period",
    "targetPeriod": null,
    "exhibitStatus": "available",
    "sourceUrl": "https://www.sec.gov/Archives/edgar/data/789019/000119312526323632/msft-ex99_1.htm"
  },
  "AMZN": {
    "checkedAt": 1789304462.336406,
    "filingDate": "2026-07-30",
    "accessionNumber": "0001018724-26-000024",
    "guidanceStatus": "unavailable",
    "targetPeriod": null,
    "exhibitStatus": "available",
    "sourceUrl": "https://www.sec.gov/Archives/edgar/data/1018724/000101872426000024/amzn-20260630xex992.htm"
  },
  "META": {
    "checkedAt": 1789221603.113387,
    "filingDate": "2026-07-29",
  ...
  "AAPL": {
    ...
    "targetPeriod": null,
    "exhibitStatus": "available",
    "sourceUrl": "https://www.sec.gov/Archives/edgar/data/320193/000032019326000018/a8-kex991q3202606272026.htm"
  },
  "PLTR": {
    "checkedAt": 1789435214.0475078,
    "filingDate": "2026-08-03",
    "accessionNumber": "0001321655-26-000039",
    "guidanceStatus": "available",
    "targetPeriod": "q3 2026",
  ...
  "VST": {
    ...
    "accessionNumber": "0001692819-26-000017",
    "guidanceStatus": "unavailable",
    "targetPeriod": "second quarter 2025",
    "exhibitStatus": "available",
    "sourceUrl": "https://www.sec.gov/Archives/edgar/data/1692819/000169281926000017/vistra-20260630xearningsre.htm"
  },
  "ETN": {
    "checkedAt": 1789388953.3311799,
    "filingDate": "2026-07-31",
    "accessionNumber": "0001551182-26-000027",
    "guidanceStatus": "available",
    "targetPeriod": "first quarter 2027",
