...
const INDEPENDENT_VALUATION_DATA = {
  ...
  "AMAT": {
    "relativeValueBand": {
      ...
      "comparisonPriceLabel": "최근 확인된 확정 종가",
      "comparisonPriceNote": "오늘(2026-09-23) 장중 관측값 $469.80999755859375은(는) 아직 정규장이 끝나지 않아 확정 종가가 아니므로 계산에 쓰지 않았고, 그 직전 확정 종가를 대신 씁니다. 참고: 2026-09-22에는 이 캐시에 일봉 자체가 없습니다(휴장일인지 자료 결측인지는 확인되지 않음) -- 그래서 이 값이 반드시 '전 거래일' 값은 아닐 수 있습니다.",
      ...
      "generatedAt": "2026-09-24T04:02:45.290598+09:00",
      "asOfDate": "2026-09-24",
      "lastCheckStatus": "OK",
      "lastCheckNote": null,
  ...
  "LRCX": {
    "relativeValueBand": {
      ...
      "comparisonPriceAsOf": "2026-09-21",
      "comparisonPriceLabel": "최근 확인된 확정 종가",
      "comparisonPriceNote": "오늘(2026-09-23) 장중 관측값 $304.5893859863281은(는) 아직 정규장이 끝나지 않아 확정 종가가 아니므로 계산에 쓰지 않았고, 그 직전 확정 종가를 대신 씁니다. 참고: 2026-09-22에는 이 캐시에 일봉 자체가 없습니다(휴장일인지 자료 결측인지는 확인되지 않음) -- 그래서 이 값이 반드시 '전 거래일' 값은 아닐 수 있습니다.",
      "comparisonPriceType": "confirmed_close",
      "comparisonPriceIsIntradayFallbackSkipped": true,
      "comparisonPriceIntradayObservedDate": "2026-09-23",
      ...
      "changeReasonVsPrevious": "AMAT forward P/E 변경 (25.9853x -> 25.9628x); KLAC forward P/E 변경 (32.0169x -> 31.9978x)",
      "generatedAt": "2026-09-24T04:02:45.506862+09:00",
      "asOfDate": "2026-09-24",
      "lastCheckStatus": "OK",
      "lastCheckNote": null,
      "lastCheckWasBenignSkip": false,
  ...
  "KLAC": {
    "relativeValueBand": {
      ...
      "comparisonPriceAsOf": "2026-09-21",
      "comparisonPriceLabel": "최근 확인된 확정 종가",
      "comparisonPriceNote": "오늘(2026-09-23) 장중 관측값 $186.09500122070312은(는) 아직 정규장이 끝나지 않아 확정 종가가 아니므로 계산에 쓰지 않았고, 그 직전 확정 종가를 대신 씁니다. 참고: 2026-09-22에는 이 캐시에 일봉 자체가 없습니다(휴장일인지 자료 결측인지는 확인되지 않음) -- 그래서 이 값이 반드시 '전 거래일' 값은 아닐 수 있습니다.",
      "comparisonPriceType": "confirmed_close",
      "comparisonPriceIsIntradayFallbackSkipped": true,
      "comparisonPriceIntradayObservedDate": "2026-09-23",
      ...
      "changeReasonVsPrevious": "AMAT forward P/E 변경 (25.9853x -> 25.9628x); LRCX forward P/E 변경 (30.1504x -> 30.1320x)",
      "generatedAt": "2026-09-24T04:02:45.707346+09:00",
      "asOfDate": "2026-09-24",
      "lastCheckStatus": "OK",
      "lastCheckNote": null,
      "lastCheckWasBenignSkip": false,
  ...
  "ASML": {
    "relativeValueBand": {
      ...
      "withheldCheckedAt": "2026-09-24T04:02:45.916824+09:00",
      "neverSucceeded": true
    },
    "longTermScenario": {
  ...
  "STX": {
    "relativeValueBand": {
      ...
      "withheldCheckedAt": "2026-09-24T04:02:46.083712+09:00",
    ...
    "singleComparisonReference": {
      "lastCheckStatus": "OK",
      "lastCheckNote": null,
      "lastCheckCheckedAt": "2026-09-24T04:02:46.608702+09:00",
      "ok": true,
      "reason": null,
      ...
      "asOfDate": "2026-09-24",
      "generatedAt": "2026-09-24T04:02:46.608702+09:00",
      "generatedAtClass": "ok",
  ...
  "WDC": {
    "relativeValueBand": {
      ...
      "withheldCheckedAt": "2026-09-24T04:02:46.166497+09:00",
      "neverSucceeded": false,
      "priorLocalSnapshotFound": true,
      "priorLocalSnapshotNote": "로컬에 이전 산출물(스냅샷)이 있었고, peer 적합성/입력 정의 재검토 결과 무효화되어 지금은 보류 상태임. 이 필드는 로컬 산출 이력만 나타내며, 그 값이 실제로 공개 URL에 노출된 적이 있었는지는 이 함수가 확인할 수 없다 -- 공개 이력은 별도로 확보한 증거(공개 URL 캡처 등)로만 판단해야 한다. 아래 prior* 필드는 로컬 역사적 기록일 뿐 현재 유효한 참고범위가 아니다.",
  ...
  "SNDK": {
    "relativeValueBand": {
      ...
      "withheldCheckedAt": "2026-09-24T04:02:46.250313+09:00",
      "neverSucceeded": false,
      "priorLocalSnapshotFound": true,
      "priorLocalSnapshotNote": "로컬에 이전 산출물(스냅샷)이 있었고, peer 적합성/입력 정의 재검토 결과 무효화되어 지금은 보류 상태임. 이 필드는 로컬 산출 이력만 나타내며, 그 값이 실제로 공개 URL에 노출된 적이 있었는지는 이 함수가 확인할 수 없다 -- 공개 이력은 별도로 확보한 증거(공개 URL 캡처 등)로만 판단해야 한다. 아래 prior* 필드는 로컬 역사적 기록일 뿐 현재 유효한 참고범위가 아니다.",
  ...
  "PWR": {
    "relativeValueBand": {
      ...
      "withheldStatus": "JUDGMENT_WITHHELD",
      "withheldReason": "선정 기준을 통과한 동종업계 배수가 하나도 없음 -- 밴드 산출 보류(0으로 채우지 않음)",
      "withheldCheckedAt": "2026-09-24T04:02:46.293574+09:00",
      "neverSucceeded": false,
      "priorLocalSnapshotFound": true,
      "priorLocalSnapshotNote": "로컬에 이전 산출물(스냅샷)이 있었고, peer 적합성/입력 정의 재검토 결과 무효화되어 지금은 보류 상태임. 이 필드는 로컬 산출 이력만 나타내며, 그 값이 실제로 공개 URL에 노출된 적이 있었는지는 이 함수가 확인할 수 없다 -- 공개 이력은 별도로 확보한 증거(공개 URL 캡처 등)로만 판단해야 한다. 아래 prior* 필드는 로컬 역사적 기록일 뿐 현재 유효한 참고범위가 아니다.",
  ...
  "EME": {
    "relativeValueBand": {
      ...
      "withheldCheckedAt": "2026-09-24T04:02:46.337322+09:00",
      "neverSucceeded": false,
      "priorLocalSnapshotFound": true,
      "priorLocalSnapshotNote": "로컬에 이전 산출물(스냅샷)이 있었고, peer 적합성/입력 정의 재검토 결과 무효화되어 지금은 보류 상태임. 이 필드는 로컬 산출 이력만 나타내며, 그 값이 실제로 공개 URL에 노출된 적이 있었는지는 이 함수가 확인할 수 없다 -- 공개 이력은 별도로 확보한 증거(공개 URL 캡처 등)로만 판단해야 한다. 아래 prior* 필드는 로컬 역사적 기록일 뿐 현재 유효한 참고범위가 아니다.",
  ...
  "FIX": {
    "relativeValueBand": {
      ...
      "withheldCheckedAt": "2026-09-24T04:02:46.420024+09:00",
      "neverSucceeded": false,
      "priorLocalSnapshotFound": true,
      "priorLocalSnapshotNote": "로컬에 이전 산출물(스냅샷)이 있었고, peer 적합성/입력 정의 재검토 결과 무효화되어 지금은 보류 상태임. 이 필드는 로컬 산출 이력만 나타내며, 그 값이 실제로 공개 URL에 노출된 적이 있었는지는 이 함수가 확인할 수 없다 -- 공개 이력은 별도로 확보한 증거(공개 URL 캡처 등)로만 판단해야 한다. 아래 prior* 필드는 로컬 역사적 기록일 뿐 현재 유효한 참고범위가 아니다.",
