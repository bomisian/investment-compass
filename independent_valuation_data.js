...
const INDEPENDENT_VALUATION_DATA = {
  ...
  "AMAT": {
    "relativeValueBand": {
      ...
      "generatedAt": "2026-09-20T20:46:41.349667",
      "asOfDate": "2026-09-20",
      "lastCheckStatus": "SKIPPED_RATE_LIMIT",
      "lastCheckNote": "직전 기록(2026-09-20T20:46:41.349667) 이후 38.6초밖에 지나지 않아(60초 미만) 이번 실행은 건너뜀.",
      ...
      "staleReferenceNote": "화면에 보이는 참고범위·비교가격은 실시간이 아니라 과거 참고값입니다 -- 가장 최근 시도(SKIPPED_RATE_LIMIT)가 새 판단을 만들지 못했습니다(사유: 직전 기록(2026-09-20T20:46:41.349667) 이후 38.6초밖에 지나지 않아(60초 미만) 이번 실행은 건너뜀.).",
      "conditionsForChange": [
    ...
    "valuation": {
      ...
      "runId": "AMAT_REAL_20260920T195702936783",
      "scenarioFamilyId": "AMAT_SCEN_FAMILY_20260920T195702905802",
      ...
      "scenarios": {
        "conservative": {
          ...
          "runId": "AMAT_REAL_20260920T195702912706"
        },
        "base": {
          "px": 191.2990663575951,
        ...
        "optimistic": {
          ...
          "runId": "AMAT_REAL_20260920T195702961542"
        }
      },
      ...
      "updateStatus": {
        ...
        "failureType": null,
        "attemptedAt": "2026-09-20T19:57:02.944430",
        "dataAsOf": "2026-09-18",
        "holdPrice": false,
        "reason": ""
      },
  ...
  "LRCX": {
    "relativeValueBand": {
      ...
      "changeReasonVsPrevious": "입력값 완전 동일(변경 없음) -- 밴드(EPS·peer 배수) 근거 불변, 현재가만 바뀌었어도 밴드 자체는 재계산하지 않음",
      "generatedAt": "2026-09-20T20:46:41.524305",
      "asOfDate": "2026-09-20",
      "lastCheckStatus": "SKIPPED_RATE_LIMIT",
      "lastCheckNote": "직전 기록(2026-09-20T20:46:41.524305) 이후 38.5초밖에 지나지 않아(60초 미만) 이번 실행은 건너뜀.",
      "priceAgeDaysAtBuild": 2,
      "snapshotAgeDaysAtBuild": 0,
      "priceDateClass": "ok",
      "snapshotDateClass": "ok",
      ...
      "builtAt": "2026-09-20",
      "isStaleReference": true,
      "staleReferenceNote": "화면에 보이는 참고범위·비교가격은 실시간이 아니라 과거 참고값입니다 -- 가장 최근 시도(SKIPPED_RATE_LIMIT)가 새 판단을 만들지 못했습니다(사유: 직전 기록(2026-09-20T20:46:41.524305) 이후 38.5초밖에 지나지 않아(60초 미만) 이번 실행은 건너뜀.).",
      "conditionsForChange": [
  ...
  "KLAC": {
    "relativeValueBand": {
      ...
      "changeReasonVsPrevious": "입력값 완전 동일(변경 없음) -- 밴드(EPS·peer 배수) 근거 불변, 현재가만 바뀌었어도 밴드 자체는 재계산하지 않음",
      "generatedAt": "2026-09-20T20:46:41.688517",
      "asOfDate": "2026-09-20",
      "lastCheckStatus": "SKIPPED_RATE_LIMIT",
      "lastCheckNote": "직전 기록(2026-09-20T20:46:41.688517) 이후 38.3초밖에 지나지 않아(60초 미만) 이번 실행은 건너뜀.",
      "priceAgeDaysAtBuild": 2,
      "snapshotAgeDaysAtBuild": 0,
      "priceDateClass": "ok",
      "snapshotDateClass": "ok",
      ...
      "builtAt": "2026-09-20",
      "isStaleReference": true,
      "staleReferenceNote": "화면에 보이는 참고범위·비교가격은 실시간이 아니라 과거 참고값입니다 -- 가장 최근 시도(SKIPPED_RATE_LIMIT)가 새 판단을 만들지 못했습니다(사유: 직전 기록(2026-09-20T20:46:41.688517) 이후 38.3초밖에 지나지 않아(60초 미만) 이번 실행은 건너뜀.).",
      "conditionsForChange": [
  ...
  "ASML": {
    "relativeValueBand": {
      ...
      "withheldCheckedAt": "2026-09-20T20:47:19.990855"
    }
  }
};
