...
const INDEPENDENT_VALUATION_DATA = {
  ...
  "AMAT": {
    "relativeValueBand": {
      ...
      "generatedAt": "2026-09-21T08:03:44.410905",
      "asOfDate": "2026-09-21",
      "lastCheckStatus": "OK",
      "lastCheckNote": null,
  ...
  "LRCX": {
    "relativeValueBand": {
      ...
      "generatedAt": "2026-09-21T08:03:44.592123",
      "asOfDate": "2026-09-21",
      "lastCheckStatus": "OK",
      "lastCheckNote": null,
      "priceAgeDaysAtBuild": 3,
  ...
  "KLAC": {
    "relativeValueBand": {
      ...
      "generatedAt": "2026-09-21T08:03:44.766987",
      "asOfDate": "2026-09-21",
      "lastCheckStatus": "OK",
      "lastCheckNote": null,
      "priceAgeDaysAtBuild": 3,
  ...
  "ASML": {
    "relativeValueBand": {
      ...
      "withheldCheckedAt": "2026-09-21T08:03:44.937351"
    }
  },
  "STX": {
    "relativeValueBand": {
      ...
      "withheldCheckedAt": "2026-09-21T08:03:45.091195",
  ...
  "WDC": {
    "relativeValueBand": {
      ...
      "withheldCheckedAt": "2026-09-21T08:03:45.173336",
      "priorSnapshotInvalidated": true,
      "priorSnapshotInvalidatedNote": "이전 방법론(peer 구성)으로 계산된 값이 실제로 존재했고 공개된 적이 있으나, peer 적합성 재검토 결과 방법론 오류로 회수(무효화)되어 지금은 보류 상태임. 아래 prior* 필드는 역사적 기록일 뿐 현재 유효한 참고범위가 아님.",
  ...
  "SNDK": {
    "relativeValueBand": {
      ...
      "withheldCheckedAt": "2026-09-21T08:03:45.253247",
      "priorSnapshotInvalidated": true,
      "priorSnapshotInvalidatedNote": "이전 방법론(peer 구성)으로 계산된 값이 실제로 존재했고 공개된 적이 있으나, peer 적합성 재검토 결과 방법론 오류로 회수(무효화)되어 지금은 보류 상태임. 아래 prior* 필드는 역사적 기록일 뿐 현재 유효한 참고범위가 아님.",
  ...
  "PWR": {
    "relativeValueBand": {
      ...
      "withheldStatus": "JUDGMENT_WITHHELD",
      "withheldReason": "선정 기준을 통과한 동종업계 배수가 하나도 없음 -- 밴드 산출 보류(0으로 채우지 않음)",
      "withheldCheckedAt": "2026-09-21T08:03:45.294923",
      "priorSnapshotInvalidated": true,
      "priorSnapshotInvalidatedNote": "이전 방법론(peer 구성)으로 계산된 값이 실제로 존재했고 공개된 적이 있으나, peer 적합성 재검토 결과 방법론 오류로 회수(무효화)되어 지금은 보류 상태임. 아래 prior* 필드는 역사적 기록일 뿐 현재 유효한 참고범위가 아님.",
  ...
  "EME": {
    "relativeValueBand": {
      ...
      "withheldCheckedAt": "2026-09-21T08:03:45.337428",
      "priorSnapshotInvalidated": true,
      "priorSnapshotInvalidatedNote": "이전 방법론(peer 구성)으로 계산된 값이 실제로 존재했고 공개된 적이 있으나, peer 적합성 재검토 결과 방법론 오류로 회수(무효화)되어 지금은 보류 상태임. 아래 prior* 필드는 역사적 기록일 뿐 현재 유효한 참고범위가 아님.",
  ...
  "FIX": {
    "relativeValueBand": {
      ...
      "withheldCheckedAt": "2026-09-21T08:03:45.419505",
      "priorSnapshotInvalidated": true,
      "priorSnapshotInvalidatedNote": "이전 방법론(peer 구성)으로 계산된 값이 실제로 존재했고 공개된 적이 있으나, peer 적합성 재검토 결과 방법론 오류로 회수(무효화)되어 지금은 보류 상태임. 아래 prior* 필드는 역사적 기록일 뿐 현재 유효한 참고범위가 아님.",
