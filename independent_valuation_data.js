...
const INDEPENDENT_VALUATION_DATA = {
  ...
  "AMAT": {
    "relativeValueBand": {
      ...
      "generatedAt": "2026-09-20T17:43:00.285756",
      "asOfDate": "2026-09-20",
      "lastCheckStatus": "SKIPPED_RATE_LIMIT",
      "lastCheckNote": "직전 기록(2026-09-20T17:43:00.285756) 이후 36.6초밖에 지나지 않아(60초 미만) 이번 실행은 건너뜀 -- 반복 호출로 이력이 무한정 불어나는 것을 막기 위한 안전장치. 스냅샷/화면은 변경하지 않음.",
      ...
      "staleReferenceNote": "화면에 보이는 참고범위·비교가격은 실시간이 아니라 과거 참고값입니다 -- 가장 최근 시도(SKIPPED_RATE_LIMIT)가 새 판단을 만들지 못했습니다(사유: 직전 기록(2026-09-20T17:43:00.285756) 이후 36.6초밖에 지나지 않아(60초 미만) 이번 실행은 건너뜀 -- 반복 호출로 이력이 무한정 불어나는 것을 막기 위한 안전장치. 스냅샷/화면은 변경하지 않음.)."
    },
    "valuation": {
