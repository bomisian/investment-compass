...
const INDEPENDENT_VALUATION_DATA = {
  "VST": {
    ...
    "priceMultipleDiagnosticOnly": {
      "lastCheckStatus": "OK",
      "lastCheckNote": null,
      "lastCheckCheckedAt": "2026-09-24T22:56:43.274190+09:00",
      "ok": true,
      "reason": null,
      ...
      "multiples": {
        ...
        "ntm": {
          ...
          "per": 13.610151166863458,
          "per_price_basis_note": "현재가 $137.9700(2026-09-23) / 해당 기간 EPS"
        }
      },
      "asOfDate": "2026-09-24",
      "generatedAt": "2026-09-24T22:56:43.274190+09:00",
      "generatedAtClass": "ok",
    ...
    "singleComparisonReference": {
      "lastCheckStatus": "OK",
      "lastCheckNote": null,
      "lastCheckCheckedAt": "2026-09-24T22:56:41.688168+09:00",
      "ok": true,
      "reason": null,
  ...
  "AMAT": {
    "relativeValueBand": {
      ...
      "available": true,
      "rangeLow": 547.7022576266983,
      "rangeHigh": 584.2504446673561,
      "rangeMid": 565.9763511470271,
      ...
      "generatedAt": "2026-09-24T22:55:59.450498+09:00",
      "asOfDate": "2026-09-24",
      "lastCheckStatus": "SKIPPED_RATE_LIMIT",
      "lastCheckNote": "직전 기록(2026-09-24T22:55:59.450498+09:00) 이후 38.5초밖에 지나지 않아(60초 미만) 이번 실행은 건너뜀.",
      "lastCheckWasBenignSkip": true,
      "lastCheckBenignSkipNote": "마지막 실행(SKIPPED_RATE_LIMIT)은 직전 판단과 너무 가까운 시간에 다시 요청돼 중복 호출로 생략됐습니다(사유: 직전 기록(2026-09-24T22:55:59.450498+09:00) 이후 38.5초밖에 지나지 않아(60초 미만) 이번 실행은 건너뜀.) -- 재계산하지 않고 아래 마지막 정상 스냅샷을 그대로 재사용합니다. 이 스냅샷 자체는 아래 노후 기준으로도 여전히 유효합니다.",
      ...
      "priceMultipleDiagnostic": {
        ...
        "folded_required_eps_if_multiple_held": {
          ...
          "by_multiple": {
            ...
            "ntm": {
              "required_eps_if_multiple_unchanged": 19.589187839855786,
              "vs_same_period_eps_pct": 9.553100894182155
            }
          }
        }
  ...
  "LRCX": {
    "relativeValueBand": {
      ...
      "rangeKind": "peer_multiple_reference_range_not_a_buy_zone",
      "available": true,
      "rangeLow": 266.14366709560903,
      "rangeHigh": 327.7848017317312,
      "rangeMid": 296.9642344136701,
      ...
      "changeReasonVsPrevious": "입력값 완전 동일(변경 없음) -- 밴드(EPS·peer 배수) 근거 불변, 현재가만 바뀌었어도 밴드 자체는 재계산하지 않음",
      "generatedAt": "2026-09-24T22:55:59.698668+09:00",
      "asOfDate": "2026-09-24",
      "lastCheckStatus": "SKIPPED_RATE_LIMIT",
      "lastCheckNote": "직전 기록(2026-09-24T22:55:59.698668+09:00) 이후 38.3초밖에 지나지 않아(60초 미만) 이번 실행은 건너뜀.",
      "lastCheckWasBenignSkip": true,
      "lastCheckBenignSkipNote": "마지막 실행(SKIPPED_RATE_LIMIT)은 직전 판단과 너무 가까운 시간에 다시 요청돼 중복 호출로 생략됐습니다(사유: 직전 기록(2026-09-24T22:55:59.698668+09:00) 이후 38.3초밖에 지나지 않아(60초 미만) 이번 실행은 건너뜀.) -- 재계산하지 않고 아래 마지막 정상 스냅샷을 그대로 재사용합니다. 이 스냅샷 자체는 아래 노후 기준으로도 여전히 유효합니다.",
      "priceAgeDaysAtBuild": 1,
      "snapshotAgeDaysAtBuild": 0,
      "priceDateClass": "ok",
      "snapshotDateClass": "ok",
  ...
  "KLAC": {
    "relativeValueBand": {
      ...
      "rangeKind": "peer_multiple_reference_range_not_a_buy_zone",
      "available": true,
      "rangeLow": 152.5322382211667,
      "rangeHigh": 176.10828950352587,
      "rangeMid": 164.32026386234628,
      ...
      "changeReasonVsPrevious": "입력값 완전 동일(변경 없음) -- 밴드(EPS·peer 배수) 근거 불변, 현재가만 바뀌었어도 밴드 자체는 재계산하지 않음",
      "generatedAt": "2026-09-24T22:55:59.914140+09:00",
      "asOfDate": "2026-09-24",
      "lastCheckStatus": "SKIPPED_RATE_LIMIT",
      "lastCheckNote": "직전 기록(2026-09-24T22:55:59.914140+09:00) 이후 38.1초밖에 지나지 않아(60초 미만) 이번 실행은 건너뜀.",
      "lastCheckWasBenignSkip": true,
      "lastCheckBenignSkipNote": "마지막 실행(SKIPPED_RATE_LIMIT)은 직전 판단과 너무 가까운 시간에 다시 요청돼 중복 호출로 생략됐습니다(사유: 직전 기록(2026-09-24T22:55:59.914140+09:00) 이후 38.1초밖에 지나지 않아(60초 미만) 이번 실행은 건너뜀.) -- 재계산하지 않고 아래 마지막 정상 스냅샷을 그대로 재사용합니다. 이 스냅샷 자체는 아래 노후 기준으로도 여전히 유효합니다.",
      "priceAgeDaysAtBuild": 1,
      "snapshotAgeDaysAtBuild": 0,
      "priceDateClass": "ok",
      "snapshotDateClass": "ok",
  ...
  "ASML": {
    "relativeValueBand": {
      ...
      "withheldCheckedAt": "2026-09-24T22:56:38.012750+09:00",
      "neverSucceeded": true
    },
    "longTermScenario": {
  ...
  "STX": {
    "relativeValueBand": {
      ...
      "available": false,
      "withheldStatus": "JUDGMENT_WITHHELD",
      "withheldReason": "band_high(837.8715772659891)<=band_low(837.8715772659891) -- 밴드 폭이 0 이하",
      "withheldCheckedAt": "2026-09-24T22:56:38.200418+09:00",
    ...
    "singleComparisonReference": {
      ...
      "targetEps1Basis": "NTM 컨센서스 EPS(blend_ntm_eps_from_annual_estimates, peer와 동일 함수로 산출)",
      "peerForwardPe": 20.741063243468364,
      "peerPrice": 473.69000244140625,
      "peerPriceAsOf": "2026-09-23",
      "appliedPrice": 837.8715772659891,
  ...
  "WDC": {
    "relativeValueBand": {
      ...
      "available": false,
      "withheldStatus": "JUDGMENT_WITHHELD",
      "withheldReason": "band_high(522.3034777533361)<=band_low(522.3034777533361) -- 밴드 폭이 0 이하",
      "withheldCheckedAt": "2026-09-24T22:56:38.286473+09:00",
      "neverSucceeded": false,
      "priorLocalSnapshotFound": true,
      "priorLocalSnapshotNote": "로컬에 이전 산출물(스냅샷)이 있었고, peer 적합성/입력 정의 재검토 결과 무효화되어 지금은 보류 상태임. 이 필드는 로컬 산출 이력만 나타내며, 그 값이 실제로 공개 URL에 노출된 적이 있었는지는 이 함수가 확인할 수 없다 -- 공개 이력은 별도로 확보한 증거(공개 URL 캡처 등)로만 판단해야 한다. 아래 prior* 필드는 로컬 역사적 기록일 뿐 현재 유효한 참고범위가 아니다.",
    ...
    "singleComparisonReference": {
      ...
      "targetEps1": 22.83827,
      "targetEps1Basis": "NTM 컨센서스 EPS(blend_ntm_eps_from_annual_estimates, peer와 동일 함수로 산출)",
      "peerForwardPe": 22.869660344384055,
      "peerPrice": 923.8599853515625,
      "peerPriceAsOf": "2026-09-23",
      "appliedPrice": 522.3034777533361,
  ...
  "SNDK": {
    "relativeValueBand": {
      ...
      "withheldCheckedAt": "2026-09-24T22:56:38.371430+09:00",
      "neverSucceeded": false,
      "priorLocalSnapshotFound": true,
      "priorLocalSnapshotNote": "로컬에 이전 산출물(스냅샷)이 있었고, peer 적합성/입력 정의 재검토 결과 무효화되어 지금은 보류 상태임. 이 필드는 로컬 산출 이력만 나타내며, 그 값이 실제로 공개 URL에 노출된 적이 있었는지는 이 함수가 확인할 수 없다 -- 공개 이력은 별도로 확보한 증거(공개 URL 캡처 등)로만 판단해야 한다. 아래 prior* 필드는 로컬 역사적 기록일 뿐 현재 유효한 참고범위가 아니다.",
  ...
  "PWR": {
    "relativeValueBand": {
      ...
      "withheldStatus": "JUDGMENT_WITHHELD",
      "withheldReason": "선정 기준을 통과한 동종업계 배수가 하나도 없음 -- 밴드 산출 보류(0으로 채우지 않음)",
      "withheldCheckedAt": "2026-09-24T22:56:38.415775+09:00",
      "neverSucceeded": false,
      "priorLocalSnapshotFound": true,
      "priorLocalSnapshotNote": "로컬에 이전 산출물(스냅샷)이 있었고, peer 적합성/입력 정의 재검토 결과 무효화되어 지금은 보류 상태임. 이 필드는 로컬 산출 이력만 나타내며, 그 값이 실제로 공개 URL에 노출된 적이 있었는지는 이 함수가 확인할 수 없다 -- 공개 이력은 별도로 확보한 증거(공개 URL 캡처 등)로만 판단해야 한다. 아래 prior* 필드는 로컬 역사적 기록일 뿐 현재 유효한 참고범위가 아니다.",
    ...
    "singleComparisonReference": {
      ...
      "staleReasons": [
        ...
        "비교기업(MTZ) 가격이 실제 실행시각 기준으로 2026-09-22, 2026-09-23에 아직 반영되지 않았을 수 있음(평일 기준 후보 -- 휴장일 여부는 거래소 일정으로 확인되지 않음)"
      ],
      "disclaimer": "이 값은 비교기업이 정확히 1개일 때 그 기업의 forward P/E를 대상종목 자신의 NTM EPS에 그대로 곱한 '단일 비교기업 참고가격'일 뿐이다 -- 검증된 매수가·매도가·성공확률·신뢰구간이 아니며, low/high 범위 개념 자체가 없다(peer 1개라 범위를 구성하지 않음, 산술 실패 아님). 여러 peer로 만드는 상대가치 밴드(relativeValueBand)와는 다른 개념이며 서로 바꿔 쓰면 안 된다. EPS 정의(GAAP/조정 등)의 기업 간 비교가능성은 미확인이므로(eps_definition_confirmation_level 참고) 이 적용가격도 잠정으로 취급해야 한다.",
      ...
      "peerLastCollectionStatus": {
        "checkedAt": "2026-09-24T22:56:38.841259+09:00",
        "pricesLastAttempt": {
          "outcome": "cache_fresh",
          "errorDetail": null,
  ...
  "EME": {
    "relativeValueBand": {
      ...
      "available": false,
      "withheldStatus": "JUDGMENT_WITHHELD",
      "withheldReason": "band_high(1015.2040004833046)<=band_low(1015.2040004833046) -- 밴드 폭이 0 이하",
      "withheldCheckedAt": "2026-09-24T22:56:38.460795+09:00",
      "neverSucceeded": false,
      "priorLocalSnapshotFound": true,
      "priorLocalSnapshotNote": "로컬에 이전 산출물(스냅샷)이 있었고, peer 적합성/입력 정의 재검토 결과 무효화되어 지금은 보류 상태임. 이 필드는 로컬 산출 이력만 나타내며, 그 값이 실제로 공개 URL에 노출된 적이 있었는지는 이 함수가 확인할 수 없다 -- 공개 이력은 별도로 확보한 증거(공개 URL 캡처 등)로만 판단해야 한다. 아래 prior* 필드는 로컬 역사적 기록일 뿐 현재 유효한 참고범위가 아니다.",
    ...
    "singleComparisonReference": {
      ...
      "targetEps1Basis": "NTM 컨센서스 EPS(blend_ntm_eps_from_annual_estimates, peer와 동일 함수로 산출)",
      "peerForwardPe": 28.435251415585977,
      "peerPrice": 1625.9000244140625,
      "peerPriceAsOf": "2026-09-23",
      "appliedPrice": 1015.2040004833046,
  ...
  "FIX": {
    "relativeValueBand": {
      ...
      "available": false,
      "withheldStatus": "JUDGMENT_WITHHELD",
      "withheldReason": "band_high(1204.045312986512)<=band_low(1204.045312986512) -- 밴드 폭이 0 이하",
      "withheldCheckedAt": "2026-09-24T22:56:38.545945+09:00",
      "neverSucceeded": false,
      "priorLocalSnapshotFound": true,
      "priorLocalSnapshotNote": "로컬에 이전 산출물(스냅샷)이 있었고, peer 적합성/입력 정의 재검토 결과 무효화되어 지금은 보류 상태임. 이 필드는 로컬 산출 이력만 나타내며, 그 값이 실제로 공개 URL에 노출된 적이 있었는지는 이 함수가 확인할 수 없다 -- 공개 이력은 별도로 확보한 증거(공개 URL 캡처 등)로만 판단해야 한다. 아래 prior* 필드는 로컬 역사적 기록일 뿐 현재 유효한 참고범위가 아니다.",
    ...
    "singleComparisonReference": {
      ...
      "targetEps1Basis": "NTM 컨센서스 EPS(blend_ntm_eps_from_annual_estimates, peer와 동일 함수로 산출)",
      "peerForwardPe": 21.05746397467934,
      "peerPrice": 751.7999877929688,
      "peerPriceAsOf": "2026-09-23",
      "appliedPrice": 1204.045312986512,
  ...
  "COHR": {
    "singleComparisonReference": {
      ...
      "targetEps1Basis": "NTM 컨센서스 EPS(blend_ntm_eps_from_annual_estimates, peer와 동일 함수로 산출)",
      "peerForwardPe": 37.937996431739556,
      "peerPrice": 937.0,
      "peerPriceAsOf": "2026-09-23",
      "appliedPrice": 397.8100891531546,
  ...
  "LITE": {
    "singleComparisonReference": {
      ...
      "targetEps1Basis": "NTM 컨센서스 EPS(blend_ntm_eps_from_annual_estimates, peer와 동일 함수로 산출)",
      "peerForwardPe": 28.667352261509706,
      "peerPrice": 300.6000061035156,
      "peerPriceAsOf": "2026-09-23",
      "appliedPrice": 708.0318307627331,
  ...
  "CEG": {
    ...
    "singleComparisonReference": {
      ...
      "targetTicker": "CEG",
      "peerTicker": "VST",
      "targetEps1": 12.952174383561644,
      "targetEps1Basis": "NTM 컨센서스 EPS(blend_ntm_eps_from_annual_estimates, peer와 동일 함수로 산출)",
      "peerForwardPe": 13.610151166863458,
      "peerPrice": 137.97000122070312,
      "peerPriceAsOf": "2026-09-23",
      "appliedPrice": 176.2810512998505,
